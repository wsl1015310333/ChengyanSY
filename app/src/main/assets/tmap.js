...
var centerStr = getQueryString('center');
/* ------ */
!function (window, document, undefined) {
  ...
  function hc (t, i) {
    t.hS = +new Date,
      ...
      clearTimeout(t.gQ)
    var e = t.IN
    e.nh.remove(t.url) && e.FH(),
      e = t.pN ? t.Ua : t.X,
      t.Ua = null,
    (i || t.XA) && t.Je(i ? e : null, t),
      t.KB ? (t.KB.tk(), t.KB = null) : e && (e.onload = null, e.onerror = null, e.onabort = null, t.X = null)
  }
  ...
  'undefined' != typeof window && expose(),
    L.Util = {
      ...
      stamp: function (t) {
        return t._map_id = t._map_id || ++L.Util.lastId,
          t._map_id
      },
      lastId: 0,
      ...
      template: function (t, i) {
        return t.replace(L.Util.templateRe,
          function (t, e) {
            var n = i[e]
    ...
    function () {
      ...
      var e = 0,
        ...
        s = window.cancelAnimationFrame || t('CancelAnimationFrame') || t('CancelRequestAnimationFrame') ||
          function (t) {
    ...
    L.Class.extend = function (t) {
      ...
      return t.statics && (L.extend(i, t.statics), delete t.statics),
      t.includes && (L.Util.extend.apply(null, [n].concat(t.includes)), delete t.includes),
      n.options && (t.options = L.Util.extend(L.Util.create(n.options), t.options)),
        L.extend(n, t),
        n._initHooks = [],
        n.callInitHooks = function () {
          if (!this._initHooksCalled) {
            ...
            for (var t = 0,
                   i = n._initHooks.length; i > t; t++) n._initHooks[t].call(this)
          }
        },
        i
    },
    ...
    L.Evented = L.Class.extend({
      on: function (t, i, e) {
        if ('object' == typeof t) for (var n in t) this._on(n, t[n], i);
          ...
          for (var s = 0,
                 o = t.length; o > s; s++) this._on(t[s], i, e)
        }
        return this
      },
      off: function (t, i, e) {
        if (t) if ('object' == typeof t) for (var n in t) this._off(n, t[n], i);
          ...
          t = L.Util.splitWords(t)
          for (var s = 0,
                 o = t.length; o > s; s++) this._off(t[s], i, e)
      ...
      _off: function (t, i, e) {
        var n = this._events,
          ...
          o = t + '_len'
        if (n) {
          if (!i) return delete n[t],
            delete n[s],
            void delete n[o]
          var a, r, h, l, u, c = e && e !== this && L.stamp(e)
          if (c) u = L.stamp(i) + '_' + c,
            a = n[s],
          a && a[u] && (l = a[u], delete a[u], n[o]--)
      ...
      has_events: function (t, i, e) {
        var n = this._events
        if (i && e) {
          if (n && t in n) for (var s = 0; s < n[t].length; s++) if (n[t].fn === i && n[t].context === e) return !0
          return !1
        }
      ...
      emit: function (t, i) {
        ...
        for (var e = L.extend({
          ...
          i), n = [].concat(this._events[t]),
               s = 0; s < n.length; s++) n[s].fn && (n[s].fn.call(n[s].context || this, e), n[s].once && this._events[t].splice(s, 1));
        return this
      },
      fire: function (t, i, e) {
      ...
      addEventParent: function (t) {
        return this._eventParents = this._eventParents || {},
          this._eventParents[L.stamp(t)] = t,
          this
      },
      removeEventParent: function (t) {
        return this._eventParents && delete this._eventParents[L.stamp(t)],
          this
      },
  ...
  proto.addEventListener = proto.on,
    ...
    L.Bounds.prototype = {
      ...
      contains: function (t) {
        var i, e
        return t = 'number' == typeof t[0] || t instanceof L.Point ? L.point(t) : L.bounds(t),
          t instanceof L.Bounds ? (i = t.min, e = t.max) : i = e = t,
    ...
    L.Transformation.prototype = {
      ...
      untransform: function (t, i) {
        return i = i || 1,
          new L.Point((t.x / i - this._b) / this._a, (t.y / i - this._d) / this._c)
      }
    },
    L.DomUtil = {
      get: function (t) {
      ...
      addClass: function (t, i) {
        if (t.classList !== undefined) for (var e = L.Util.splitWords(i), n = 0,
                                              s = e.length; s > n; n++) t.classList.add(e[n]);
    ...
    L.LatLngBounds.prototype = {
      extend: function (t) {
        ...
        return n || s ? (n.lat = Math.min(i.lat, n.lat), n.lng = Math.min(i.lng, n.lng), s.lat = Math.max(e.lat, s.lat), s.lng = Math.max(e.lng, s.lng)) : (this.southwest = new L.LatLng(i.lat, i.lng), this.northeast = new L.LatLng(e.lat, e.lng)),
          this
      },
      pad: function (t) {
      ...
      contains: function (t) {
        ...
        var i, e, n = this.southwest,
          s = this.northeast
        return t instanceof L.LatLngBounds ? (i = t.getSouthWest(), e = t.getNorthEast()) : i = e = t,
        i.lat >= n.lat && e.lat <= s.lat && i.lng >= n.lng && e.lng <= s.lng
      },
      intersects: function (t) {
        t = L.latLngBounds(t)
        var i = this.southwest,
    ...
    L.Map = L.Evented.extend({
      ...
      initialize: function (t, i) {
        i = L.setOptions(this, i),
          this._initContainer(t),
          this._initLayout(),
          this._onResize = L.bind(this._onResize, this),
          this._initEvents(),
        i.maxBounds && this.setMaxBounds(i.maxBounds),
        i.zoom !== undefined && (this._zoom = this._limitZoom(i.zoom)),
        i.center && i.zoom !== undefined && this.setView(L.latLng(i.center), i.zoom, {
          reset: !0
        }),
          this._handlers = [],
          this._layers = {},
      ...
      setView: function (t, i) {
        return i = i === undefined ? this.getZoom() : i,
          this._resetView(L.latLng(t), i),
          this
      },
      ...
      _getBoundsCenterZoom: function (t, i) {
        i = i || {},
          t = t.getBounds ? t.getBounds() : L.latLngBounds(t)
      ...
      panBy: function (t) {
        return this.fire('movestart'),
          this._rawPanBy(L.point(t)),
          this.fire('move'),
          this.fire('moveend')
      },
      setMaxBounds: function (t) {
        return t = L.latLngBounds(t),
          this.options.maxBounds = t,
          t ? (this.options.maxBounds && this.off('moveend', this._panInsideMaxBounds), this._loaded && this._panInsideMaxBounds(), this.on('moveend', this._panInsideMaxBounds)) : this.off('moveend', this._panInsideMaxBounds)
      },
      setZoomLevels: function (t, i) {
        return this.options.maxZoom = i,
          this.options.minZoom = t,
          this._loaded && this.getZoom() > this.options.maxZoom ? this.setZoom(i) : this._loaded && this.getZoom() < this.options.minZoom ? this.setZoom(t) : this
      },
      ...
      stop: function () {
        return L.Util.cancelAnimFrame(this._flyToFrame),
      ...
      remove: function () {
        ...
        return L.DomUtil.removeClass(this._container, L.Browser.retina ? 'imap-retina' : ''),
          L.DomUtil.removeClass(this._container, 'imap-container'),
          L.DomUtil.removeClass(this._container, L.Browser.touch ? 'imap-touch' : ''),
          L.DomUtil.removeClass(this._container, L.Browser.ielt9 ? 'imap-oldie' : ''),
          L.DomUtil.removeClass(this._container, L.Browser.safari ? 'imap-safari' : ''),
          L.DomUtil.removeClass(this._container, this._fadeAnimated ? 'imap-fade-anim' : ''),
          this
      },
      ...
      getBoundsZoom: function (t, i, e) {
        ...
        e = L.point(e || [0, 0])
        do s++,
          n = this.project(h, s).subtract(this.project(r, s)).add(e).floor(),
          l = i ? n.x < a.x || n.y < a.y : a.contains(n)
        while (l && o >= s)
        return l && i ? null : i ? s : s - 1
      },
      getSize: function () {
        return (!this._size || this._sizeChanged) && (this._size = new L.Point(this._container.clientWidth, this._container.clientHeight), this._sizeChanged = !1),
          this._size.clone()
      },
      ...
      getZoomScale: function (t, i) {
        ...
        return i = i === undefined ? this._zoom : i,
        e.scale(t) / e.scale(i)
      },
      ...
      project: function (t, i) {
        return i = i === undefined ? this._zoom : i,
          this.options.crs.latLngToPoint(L.latLng(t), i)
      },
      unproject: function (t, i) {
        return i = i === undefined ? this._zoom : i,
          this.options.crs.pointToLatLng(L.point(t), i)
      },
      ...
      _initContainer: function (t) {
        ...
        L.DomEvent.addListener(i, 'scroll', this._onScroll, this),
          i._imap = !0
      },
      _initLayout: function () {
        var t = this._container
        this._fadeAnimated = this.options.fadeAnimation && L.Browser.any3d,
          L.DomUtil.addClass(t, 'imap-container' + (L.Browser.touch ? ' imap-touch' : '') + (L.Browser.retina ? ' imap-retina' : '') + (L.Browser.ielt9 ? ' imap-oldie' : '') + (L.Browser.safari ? ' imap-safari' : '') + (this._fadeAnimated ? ' imap-fade-anim' : '')),
          this.options.vector ? t.style.background = '#fcf9f2' : t.style.backgroundImage = 'url(' + this.options.backgoundImg + ')'
      ...
      _initPanes: function () {
        ...
        this.options.markerZoomAnimation || (L.DomUtil.addClass(t.markerPane, 'imap-zoom-hide'), L.DomUtil.addClass(t.shadowPane, 'imap-zoom-hide'))
      },
      ...
      _initEvents: function (t) {
        if (L.DomEvent) {
          ...
          var i = t ? 'off' : 'on'
          L.DomEvent[i](this._container, 'click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress', this._handleDOMEvent, this),
          this.options.trackResize && L.DomEvent[i](window, 'resize', this._onResize, this),
          L.Browser.any3d && this.options.transform3DLimit && this[i]('moveend', this._onMoveEnd)
        }
      },
      _onResize: function () {
      ...
      _findEventTargets: function (t, i) {
        ...
        return n.length || s || !L.DomEvent._isExternalTarget(o, t) || (n = [this]),
          n
      },
        ...
        if (this._loaded && !L.DomEvent._skipped(t)) {
          ...
          if ('click' === t.type) {
            var e = L.Util.extend({},
              t)
            e.type = 'preclick',
              this._handleDOMEvent(e)
          }
          'mousedown' === i && L.DomUtil.preventOutline(t.target || t.srcElement),
      ...
      _fireDOMEvent: function (t, i, e) {
        if (!t._stopped && (e = (e || []).concat(this._findEventTargets(t, i)), e.length)) {
          ...
          if ('contextmenu' === i && L.DomEvent.preventDefault(t), 'click' !== t.type && 'preclick' !== t.type || t._simulated || !this._draggableMoved(n)) {
            ...
            for (var a = 0; a < e.length; a++) if (e[a].fire(i, s, !0), s.originalEvent._stopped || e[a].options.nonBubblingEvents && -1 !== L.Util.indexOf(e[a].options.nonBubblingEvents, i)) return
          }
        }
      },
      _draggableMoved: function (t) {
        return t = t.options.draggable ? t : this,
        t.dragging && t.dragging.moved() || this.boxZoom && this.boxZoom.moved()
      },
      _clearHandlers: function () {
        for (var t = 0,
               i = this._handlers.length; i > t; t++) this._handlers[t].disable()
      },
      ...
      _limitZoom: function (t) {
        var i = this.getMinZoom(),
          e = this.getMaxZoom()
        return L.Browser.any3d || (t = Math.round(t)),
      ...
      _getTileId: function (t) {
        ...
        return e.y = -(e.y + 1 - Math.pow(2, this._zoom)),
          e.z = this._zoom,
          e
      }
    }),
    ...
    L.Http = {},
    L.Http.Request = L.Evented.extend({
      opts: {
        callback: 'callback',
        type: 'json'
      },
    ...
    L.Http.JSONP = L.Http.Request.extend({
      send: function (t) {
        ...
        window[i] = s,
          e.src = t + '&' + this.opts.callback + '=window.' + i,
    ...
    L.Layer = L.Evented.extend({
      ...
      addInteractiveTarget: function (t) {
        return this._map._targets[L.stamp(t)] = this,
          this
      },
      removeInteractiveTarget: function (t) {
        return delete this._map._targets[L.stamp(t)],
          this
      },
    ...
    L.Map.include({
      ...
      changeBGLayer: function (t) {
        ...
        if (0 == t.type) {
          var e = L.stamp(t)
          return i._layers[e] ? (i._baseLayer = t, t.beforeAdd(i)) : i.addLayer(t),
            !0
        }
        return !1
      },
      ...
      _addLayers: function (t) {
        ...
        for (var i = 0,
               e = t.length; e > i; i++) this.addLayer(t[i])
      },
      ...
      _updateZoomLevels: function () {
        ...
        for (var n in this._zoomBoundLayers) {
          ...
          t = s.minZoom === undefined ? t : Math.min(t, s.minZoom),
            i = s.maxZoom === undefined ? i : Math.max(i, s.maxZoom)
        }
        this._layersMaxZoom = i === -(1 / 0) ? undefined : i,
          this._layersMinZoom = t === 1 / 0 ? undefined : t,
  ...
  L.DomEvent = {
    on: function (t, i, e, n) {
      if ('object' == typeof i) for (var s in i) this._on(t, s, i[s], e);
        ...
        for (var o = 0,
               a = i.length; a > o; o++) this._on(t, i[o], e, n)
      }
      return this
    },
    off: function (t, i, e, n) {
      if ('object' == typeof i) for (var s in i) this._off(t, s, i[s], e);
        ...
        i = L.Util.splitWords(i)
        for (var o = 0,
               a = i.length; a > o; o++) this._off(t, i[o], e, n)
      }
      return this
    },
    _on: function (t, i, e, n) {
      ...
      return L.Browser.pointer && 0 === i.indexOf('touch') ? this.addPointerListener(t, i, o, s) : L.Browser.touch && 'dblclick' === i && this.addDoubleTapListener ? this.addDoubleTapListener(t, o, s) : 'addEventListener' in t ? 'mousewheel' === i ? (t.addEventListener('DOMMouseScroll', o, !1), t.addEventListener(i, o, !1)) : 'mouseenter' === i || 'mouseleave' === i ? (o = function (i) {
        i = i || window.event,
        L.DomEvent._isExternalTarget(t, i) && a(i)
      },
      ...
      }), t.addEventListener(i, o, !1)) : 'attachEvent' in t && t.attachEvent('on' + i, o),
    ...
    disableClickPropagation: function (t) {
      ...
      return L.DomEvent.on(t, L.Draggable.START.join(' '), i),
        L.DomEvent.on(t, {
    ...
    L.PosAnimation = L.Evented.extend({
      run: function (t, i, e, n) {
        this.stop(),
          ...
          this._startPos = L.DomUtil.getPosition(t),
      ...
      _runFrame: function (t, i) {
        ...
        i && e._round(),
          L.DomUtil.setPosition(this._el, e),
          this.fire('step')
      },
      _complete: function () {
    ...
    L.Map.include({
      setView: function (t, i, e) {
        if (i = i === undefined ? this._zoom : this._limitZoom(i), t = this._limitCenter(L.latLng(t), i, this.options.maxBounds), e = e || {},
            this.stop(), this._loaded && !e.reset && e !== !0) {
          ...
          if (n) return clearTimeout(this._sizeTimer),
            this
        }
      ...
      panBy: function (t, i) {
        if (t = L.point(t).round(), i = i || {},
          !t.x && !t.y) return this.fire('moveend')
        if (i.animate !== !0 && !this.getSize().contains(t)) return this._resetView(this.unproject(this.project(this.getCenter()).add(t)), this.getZoom()),
          this
      ...
      _onPanTransitionEnd: function () {
        L.DomUtil.removeClass(this._mapPane, 'imap-pan-anim'),
          this.fire('moveend')
      },
  ...
  zoomAnimated && L.Map.addInitHook(function () {
    ...
    this._zoomAnimated && (this._createAnimProxy(), L.DomEvent.on(this._proxy, L.DomUtil.TRANSITION_END, this._catchTransitionEnd, this))
  }),
    L.Map.include(zoomAnimated ? {
      ...
      _tryAnimatedZoom: function (t, i, e) {
        ...
        if (e = e || {},
          !this._zoomAnimated || e.animate === !1 || this._nothingToAnimate() || Math.abs(i - this._zoom) > this.options.zoomAnimationThreshold) return !1
        var n = this.getZoomScale(i),
      ...
      _animateZoom: function (t, i, e, n) {
        e && (this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = i, L.DomUtil.addClass(this._mapPane, 'imap-zoom-anim')),
          this.fire('zoomanim', {
            center: t,
            zoom: i,
            noUpdate: n
    ...
    L.Map.include({
      flyTo: function (t, i, e) {
        ...
        if (e = e || {},
          e.animate === !1 || !L.Browser.any3d) return this.setView(t, i, e)
        this.stop()
    ...
    L.Draggable = L.Evented.extend({
      ...
      _onDown: function (t) {
        if (this._moved = !1, !L.DomUtil.hasClass(this._element, 'imap-zoom-anim') && !(L.Draggable._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches) && this._enabled && (L.Draggable._dragging = !0, this._preventOutline && L.DomUtil.preventOutline(this._element), !this._moving)) {
          ...
          this._startPoint = new L.Point(i.clientX, i.clientY),
            ...
            L.DomEvent.on(document, L.Draggable.MOVE[t.type], this._onMove, this).on(document, L.Draggable.END[t.type], this._onUp, this)
        }
      },
      _onMove: function (t) {
      ...
      _updatePosition: function () {
        ...
        this.fire('predrag', t),
          L.DomUtil.setPosition(this._element, this._newPos, this._element.rotate),
          this.fire('drag', t)
      },
      _onUp: function () {
        L.DomUtil.removeClass(document.body, 'imap-dragging'),
        this._lastTarget && (L.DomUtil.removeClass(this._lastTarget, 'imap-drag-target'), this._lastTarget = null)
    ...
    L.Map.Drag = L.Handler.extend({
      addHooks: function () {
        if (!this._draggable) {
          var t = this._map
          this._draggable = new L.Draggable(t._mapPane, t._container),
            this._draggable.on({
                down: this._onDown,
        ...
        L.DomUtil.addClass(this._map._container, 'imap-grab'),
          this._draggable.enable()
      },
      removeHooks: function () {
        L.DomUtil.removeClass(this._map._container, 'imap-grab'),
      ...
      _onDragStart: function () {
        ...
        if (this._map.options.maxBounds && this._map.options.maxBoundsViscosity) {
          ...
          this._offsetLimit = L.bounds(this._map.latLngToContainerPoint(i.getNorthWest()).multiplyBy(-1), this._map.latLngToContainerPoint(i.getSouthEast()).multiplyBy(-1).add(this._map.getSize())),
    ...
    L.Map.ScrollWheelZoom = L.Handler.extend({
      ...
      _onWheelScroll: function (t) {
        ...
        clearTimeout(this._timer),
          this._timer = setTimeout(L.bind(this._performZoom, this), n),
          L.DomEvent.stop(t)
      },
      _performZoom: function () {
        ...
        t.stop(),
          ...
          i = t._limitZoom(e + i) - e,
          this._delta = 0,
          this._startTime = null,
        i && ('center' === t.options.scrollWheelZoom ? t.setZoom(e + i) : t.setZoomAround(this._lastMousePos, e + i))
      }
    }),
    ...
    L.extend(L.DomEvent, {
      ...
      addDoubleTapListener: function (t, i, e) {
        ...
        return t[l + u + e] = n,
          t[l + c + e] = s,
          t.addEventListener(u, n, !1),
          t.addEventListener(c, s, !1),
          this
      },
      removeDoubleTapListener: function (t, i) {
        var e = '_imap_',
          n = t[e + this._touchend + i]
        return t.removeEventListener(this._touchstart, t[e + this._touchstart + i], !1),
    ...
    L.extend(L.DomEvent, {
      ...
      addPointerListener: function (t, i, e, n) {
        return 'touchstart' === i ? this._addPointerStart(t, e, n) : 'touchmove' === i ? this._addPointerMove(t, e, n) : 'touchend' === i && this._addPointerEnd(t, e, n),
          this
      },
      removePointerListener: function (t, i, e) {
        var n = t['_imap_' + i + e]
        return 'touchstart' === i ? t.removeEventListener(this.POINTER_DOWN, n, !1) : 'touchmove' === i ? t.removeEventListener(this.POINTER_MOVE, n, !1) : 'touchend' === i && (t.removeEventListener(this.POINTER_UP, n, !1), t.removeEventListener(this.POINTER_CANCEL, n, !1)),
          this
      },
      _addPointerStart: function (t, i, e) {
        ...
        if (t['_imap_touchstart' + e] = n, t.addEventListener(this.POINTER_DOWN, n, !1), !this._pointerDocListener) {
          ...
          document.documentElement.addEventListener(this.POINTER_DOWN, L.bind(this._globalPointerDown, this), !0),
            document.documentElement.addEventListener(this.POINTER_MOVE, L.bind(this._globalPointerMove, this), !0),
            document.documentElement.addEventListener(this.POINTER_UP, s, !0),
            document.documentElement.addEventListener(this.POINTER_CANCEL, s, !0),
      ...
      _onTouchMove: function (t) {
        if (t.touches && 2 === t.touches.length && this._zooming) {
          ...
          if (i.options.bounceAtZoomLimits || !(this._zoom <= i.getMinZoom() && 1 > s || this._zoom >= i.getMaxZoom() && s > 1)) {
            ...
            this._animRequest = L.Util.requestAnimFrame(a, this, !0),
              L.DomEvent.preventDefault(t)
          }
        }
      },
    ...
    L.Map.Tap = L.Handler.extend({
      ...
      _onDown: function (t) {
        if (t.touches) {
          if (L.DomEvent.preventDefault(t), this._fireClick = !0, t.touches.length > 1) return this._fireClick = !1,
            void clearTimeout(this._holdTimeout)
          var i = t.touches[0],
            e = i.target
          this._startPos = this._newPos = new L.Point(i.clientX, i.clientY),
          e.tagName && 'a' === e.tagName.toLowerCase() && L.DomUtil.addClass(e, 'imap-active'),
      ...
      _onUp: function (t) {
        if (clearTimeout(this._holdTimeout), L.DomEvent.off(document, {
          ...
          var i = t.changedTouches[0],
            e = i.target
          e && e.tagName && 'a' === e.tagName.toLowerCase() && L.DomUtil.removeClass(e, 'imap-active'),
      ...
      _onMove: function (t) {
        var i = t.touches[0]
        this._newPos = new L.Point(i.clientX, i.clientY),
  ...
  L.Browser.touch && !L.Browser.pointer && L.Map.addInitHook('addHandler', 'tap', L.Map.Tap),
    L.Map.mergeOptions({
      boxZoom: !0
    }),
    L.Map.BoxZoom = L.Handler.extend({
      ...
      _onMouseMove: function (t) {
        this._moved || (this._moved = !0, this._box = L.DomUtil.create('div', 'imap-zoom-box', this._container), L.DomUtil.addClass(this._container, 'imap-crosshair'), this._map.fire('boxzoomstart')),
          this._point = this._map.mouseEventToContainerPoint(t)
        var i = new L.Bounds(this._point, this._startPoint),
          e = i.getSize()
        L.DomUtil.setPosition(this._box, i.min),
          this._box.style.width = e.x + 'px',
          this._box.style.height = e.y + 'px'
      },
      _finish: function () {
        this._moved && (L.DomUtil.remove(this._box), L.DomUtil.removeClass(this._container, 'imap-crosshair')),
      ...
      _onKeyDown: function (t) {
        if (!(t.altKey || t.ctrlKey || t.metaKey)) {
          ...
          if (e in this._panKeys) {
            ...
            i = this._panKeys[e],
            t.shiftKey && (i = L.point(i).multiplyBy(3)),
              n.panBy(i),
    ...
    L.Projection.Mercator = {
      ...
      project: function (t) {
        ...
        return n = -e * Math.log(Math.max(r, 1e-10)),
          new L.Point(t.lng * i * e, n)
      },
      unproject: function (t) {
        for (var i, e = 180 / Math.PI,
               n = this.R,
               s = this.R_MINOR / n,
               o = Math.sqrt(1 - s * s), a = Math.exp(-t.y / n), r = Math.PI / 2 - 2 * Math.atan(a), h = 0,
               l = .1; 15 > h && Math.abs(l) > 1e-7; h++) i = o * Math.sin(r),
          i = Math.pow((1 - i) / (1 + i), o / 2),
          l = Math.PI / 2 - 2 * Math.atan(a * i) - r,
          r += l;
    ...
    L.GridLayer = L.Layer.extend({
      ...
      visible: function (t) {
        ...
        this._container && this.options.visible !== undefined && null !== this.options.visible && (this._container.style.display = t ? 'block' : 'none')
      },
      getVisible: function () {
      ...
      getEvents: function () {
        ...
        return this.options.updateWhenIdle || (this._onMove || (this._onMove = L.Util.throttle(this._onMoveEnd, this.options.updateInterval, this)), t.move = this._onMove),
      ...
      _setAutoZIndex: function (t) {
        for (var i, e = this.getPane().children, n = -t(-(1 / 0), 1 / 0), s = 0,
               o = e.length; o > s; s++) i = e[s].style.zIndex,
        e[s] !== this._container && i && (n = t(n, +i));
        ...
        if (this._map && !L.Browser.ielt9 && this._map._fadeAnimated) {
          ...
          for (var n in this._tiles) {
            ...
            if (s.current && s.loaded) {
              ...
              L.DomUtil.setOpacity(s.el, o),
                1 > o ? i = !0 : (s.active && (e = !0), s.active = !0)
            }
          }
          e && !this._noPrune && this._pruneTiles(),
          i && (L.Util.cancelAnimFrame(this._fadeFrame), this._fadeFrame = L.Util.requestAnimFrame(this._updateOpacity, this))
        }
      },
      ...
      _updateLevels: function () {
        ...
        return n || (n = this._levels[t] = {},
          n.el = L.DomUtil.create('div', 'imap-tile-container imap-zoom-animated', this._container), n.el.style.zIndex = i, n.origin = s.project(s.unproject(s.getPixelOrigin()), t).round(), n.zoom = t, this._setZoomTransform(n, s.getCenter(), s.getZoom()), L.Util.falseFn(n.el.offsetWidth)),
          this._level = n,
          n
      },
      _pruneTiles: function () {
        ...
        for (t in this._tiles) i = this._tiles[t],
          i.retain = i.current;
      ...
      _resetAll: function () {
        for (var t in this._levels) L.DomUtil.remove(this._levels[t].el),
      ...
      _setView: function (t, i, e, n) {
        ...
        (!n || o) && (this._tileZoom = s, this._abortLoading && this._abortLoading(), this._updateLevels(), this._resetGrid(), s !== undefined && this._update(t), e || this._pruneTiles(), this._noPrune = !!e),
      ...
      _initTile: function (t) {
        ...
        t.style.width = i.x + 'px',
          ...
          t.onselectstart = L.Util.falseFn,
          t.onmousemove = L.Util.falseFn,
        L.Browser.ielt9 && this.options.opacity < 1 && L.DomUtil.setOpacity(t, this.options.opacity),
        L.Browser.android && !L.Browser.android23 && (t.style.WebkitBackfaceVisibility = 'hidden')
      },
      _addTile: function (t, i) {
        ...
        this._initTile(s),
        this.createTile.length < 2 && L.Util.requestAnimFrame(L.bind(this._tileReady, this, t, null, s)),
          L.DomUtil.setPosition(s, e),
          this._tiles[n] = {
            el: s,
            coords: t,
            current: !0
      ...
      _tileReady: function (t, i, e) {
        if (this._map) {
          ...
          e = this._tiles[n],
          e && (e.loaded = +new Date, this._map._fadeAnimated ? (L.DomUtil.setOpacity(e.el, 0), L.Util.cancelAnimFrame(this._fadeFrame), this._fadeFrame = L.Util.requestAnimFrame(this._updateOpacity, this)) : (e.active = !0, this._pruneTiles()), L.DomUtil.addClass(e.el, 'imap-tile-loaded'), this.fire('tileload', {
            tile: e.el,
            coords: t
    ...
    L.TileLayer = L.GridLayer.extend({
      ...
      initialize: function (t, i) {
        this._url = t,
          i = L.setOptions(this, i),
        i.detectRetina && L.Browser.retina && i.maxZoom > 0 && (i.tileSize = Math.floor(i.tileSize / 2), i.zoomOffset++, i.minZoom = Math.max(0, i.minZoom), i.maxZoom--),
        'string' == typeof i.subdomains && (i.subdomains = i.subdomains.split('')),
        L.Browser.android || this.on('tileunload', this._onTileRemove)
      },
      setUrl: function (t, i) {
        return this._url = t,
        i || this.redraw(),
      ...
      createTile: function (t, i) {
        ...
        return L.DomEvent.on(e, 'load', L.bind(this._tileOnLoad, this, i, e)),
          L.DomEvent.on(e, 'error', L.bind(this._tileOnError, this, i, e)),
        this.options.crossOrigin && (e.crossOrigin = ''),
          e.alt = '',
          e.src = this.getTileUrl(t.x, t.y, this._getZoomForUrl(), t),
          e
      },
      ...
      _getZoomForUrl: function () {
        ...
        return t.zoomReverse && (i = t.maxZoom - i),
          i += t.zoomOffset,
          null !== t.maxNativeZoom ? Math.min(i, t.maxNativeZoom) : i
      },
    ...
    L.GridVectorLayer = L.Layer.extend({
      ...
      _bindMapContainerEvent: function () {
        var t, i = this._map,
          ...
          n = this
        i._panes.mapPane.parentNode && i.addEventListener('resize',
          function (i) {
            t = i.newSize,
              n._labelCanvas.width = t.x,
              n._labelCanvas.height = t.y,
              n._labelCanvas.style.width = t.x + 'px',
              n._labelCanvas.style.height = t.y + 'px',
              canvasRenderer.updateSize(t),
              canvasRenderer.yd()
          },
          e),
          this._map.on('canvas', this._pruneTiles, this)
      },
      ...
      _normalRequest: function (t, i) {
        ...
        if (canvasRenderer.updateCenter(n.lng, n.lat, i), t.length) {
          var s, o = {}
          for (var a in t) s = t[a].x + ':' + t[a].y + ':' + t[a].z,
            o[s] = this._tiles[s];
      ...
      _firstRequest: function (t) {
        var i = this._map,
          e = i.getCenter(),
          t = t || i.getZoom()
        canvasRenderer.Zd(this._container, this._labelCanvas, t, i.getSize(), this._tiles, e.lng, e.lat),
          canvasRenderer.TB(this._tiles, t)
      },
      _setView: function (t, i, e, n) {
        var s = Math.round(i);
        (this.options.maxZoom !== undefined && s > this.options.maxZoom || this.options.minZoom !== undefined && s < this.options.minZoom) && (s = undefined)
        var o = s !== this._tileZoom;
        (!n || o) && (this._tileZoom = s, this._abortLoading, this._updateLevels(), this._resetGrid(), s !== undefined && this._update(t), this._noPrune = !!e),
          this._setZoomTransforms(t, i)
      },
      _setZoomTransforms: function (t, i) {
        for (var e in this._levels) this._setZoomTransform(this._levels[e], t, i)
        ...
        if (this._map && !this._map._animatingZoom) {
          ...
          if ('move' == arguments[0].type && (canvasRenderer.__isDrawLabel = !1), this._resetView(), 'moveend' == arguments[0].type) {
            ...
            isNaN(n) || isNaN(s) ? (n = -parseInt(e[0]), s = -parseInt(e[1]), L.DomUtil.setPosition(this._labelCanvas, {
              ...
              this._normalRequest([], this._tileZoom),
              canvasRenderer.updateTiles(this._tiles),
              this._normalRequest([].concat(this._deltTiles), this._tileZoom),
              this._deltTiles = []
          }
        }
      },
    ...
    function () {
      ...
      function sb (t) {
        ...
        0 !== e.indexOf('http') && window.parent && window.parent !== window && (e = window.parent.location.href),
          e = encodeURIComponent(e),
          L.k.zo = e,
          L.k.ih = L.k.Va + '/theme/v1.3/markers/' + (L.h.sa ? 'b' : 'n'),
          L.k.mode = Number(t[3]),
          L.k.Af = t[1],
          L.k.key = t[0],
          L.k.zz = t[4],
      ...
      config.vd = 'main',
      config.h.uc && (F += ',touch', config.vd += 't'),
      config.h.Y || (F += ',mouse', config.vd += 'm'),
        config.vd += 'c',
      config.h.hg && (config.vd += 'v', F += ',vectorlayer,overlay', F += ',vp', config.vd += 'p'),
      config[7] && (F += ',' + config[7], config.vd += config[7].replace(',', '').replace(eval('/AMap./gi'), '')),
        F += ',sync',
        config.bE = F.split(','),
        window.AMap = window.AMap || {},
        window.AMap.Ag = '1.3.12.1',
        sb(config)
    }(),
    L.VectorLayer = L.GridVectorLayer.extend({
      ...
      createTile: function (t, i) {
        ...
        return this._canvasCtxCache = e.getContext('2d'),
        this.options.crossOrigin && (e.crossOrigin = ''),
          e.alt = '',
          e.width = '',
          e
    ...
    L.__Class = function () {},
    L.__Class.extend = L.__Class.extend = function (t) {
      function i () {}
      ...
      return t.ID && (L.__extend(e, t.ID), delete t.ID),
      t.jb && (L.__extend.apply(null, [n].concat(t.jb)), delete t.jb),
      t.F && n.F && (t.F = L.__extend({},
        n.F, t.F)),
        L.__extend(n, t),
      t.toString && (n.toString = t.toString),
        e.Dd = this.prototype,
        e
    },
    L.__extend = function (t) {
      var i, e, n, s, o = Array.prototype.slice.call(arguments, 1)
      for (e = 0, n = o.length; n > e; e += 1) for (i in s = o[e] || {}) Object.prototype.hasOwnProperty.call(s, i) && ('function' == typeof s[i] && 'function' == typeof t[i] && (s[i].Sa = t[i]), t[i] = s[i])
      return t
    },
    L.g = {
      Qp: [],
      ...
      pv: function (t) {
        var i, e, n, s, o
        for (e = [], n = NaN, s = 0, o = t.length; o > s; s += 1) i = t[s],
          i = this.gL.indexOf(i),
      ...
      gc: function (t, i, e, n) {
        ...
        return n = e[n.toString()],
          'number' == typeof n ? t[n] : null
      },
      Ph: function (t) {
        for (var i = [], e = 0, n = t.length; n > e; e += 2) i.push(parseInt(t.substr(e, 2), 16));
        return i.push((i.shift() / 255).toFixed(2)),
        'rgba(' + i.join(',') + ')'
      },
      Ik: function (t) {
      ...
      Vb: function () {
        var t = 0
        return function (i) {
          return i._amap_id || (t += 1, i._amap_id = t),
            i._amap_id
        }
      }(),
      ...
      ZS: function (t, i, e, n) {
        ...
        if (n) {
          ...
          s = function () {
            return o = r(),
              i > o - a ? !1 : (a = o, void t.apply(e, arguments))
          }
        } else {
          var h, l, u
          u = function () {
      ...
      KD: function (t) {
        ...
        for (var e, n = 0,
               s = t.length; s > n; n += 1) e = t.charCodeAt(n),
          i = (i << 5) - i + e,
          i &= i;
        return i
      },
      ...
      iepngFix: function (t) {
        function i () {
          for (var t; e.length;) t = e.shift(),
            window.DD_belatedPNG.fixPng(t);
          n.Wt = !0
        }
      ...
      ka: function (t) {
        if (L.g.isArray(t)) if (L.g.isArray(t[0])) for (var i = 0; i < t.length; i += 1) t[i] = L.g.ka(t[i]);
    ...
    function () {
      ...
      L.g.yg = function (t, i, e) {
        return t = L.g.bind(t, i),
          e ? void t() : s.call(window, t, void 0)
      },
        L.g.Go = function (t) {
          t && o.call(window, t)
        }
    ...
    L.oa = {
      e: function (t, i, e, n, s) {
        ...
        'complete' === t && this.Ab && this.q(t),
          this
      },
      Xd: function (t, i, e) {
        var n = this.Rf
        if (i && e) {
          if (n && t in n && n[t]) for (var s = 0; s < n[t].length; s += 1) if (n[t][s].xa === i && n[t][s].he === e) return !0
          return !1
        }
      ...
      D: function (t, i, e) {
        ...
        var n = this.Rf
        if (n && n[t]) for (var s = 0; s < n[t].length; s += 1) if (!(n[t][s].xa !== i && 'mv' !== i || e && n[t][s].he !== e)) {
          n[t].splice(s, 1),
      ...
      q: function (t, i) {
        ...
        for (var e = L.extend({
          ...
          i), n = [].concat(this.Rf[t]),
               s = 0; s < n.length; s += 1) n[s].xa && (n[s].xa.call(n[s].he || this, e), n[s].mh && this.Rf[t] && this.Rf[t].splice(s, 1));
        return this
      }
    },
  L.oa.on || (L.oa.on = L.oa.e),
  L.oa.off || (L.oa.off = L.oa.D),
  L.oa.emit || (L.oa.emit = L.oa.q),
    L.d = {
      get: function (t) {
        return 'string' == typeof t ? document.getElementById(t) : t
      },
      bT: function (t, i) {
        ...
        if (e) {
          ...
          n.setAttribute('rel', 'stylesheet'),
            ...
            i ? e.appendChild(n) : e.insertBefore(n, e.firstChild)
        } else document.write('<link rel=\'stylesheet\' href=\'' + t + '\'/>')
      },
      gc: function (t, i) {
        var e = t.style[i]
        return !e && t.currentStyle && (e = t.currentStyle[i]),
        e && 'auto' !== e || !document.defaultView || (e = (e = document.defaultView.getComputedStyle(t, null)) ? e[i] : null),
        e && 'auto' !== e || 'height' !== i || (e = t.clientHeight + 'px'),
      ...
      Ht: function (t) {
        ...
        do {
          ...
          if ('fixed' === i) {
            e += o.scrollTop || a.scrollTop || 0,
              n += o.scrollLeft || a.scrollLeft || 0
            break
          }
          s = s.offsetParent
        } while (s)
      ...
      XL: function () {
        return L.d.uG || (L.d.uG = !0, L.d.tG = 'ltr' === L.d.gc(document.body, 'direction')),
          L.d.tG
      },
      create: function (t, i, e) {
      ...
      zA: function () {
        ...
        this.MI || (this.MI = document.onselectstart, document.onselectstart = L.g.LA)
      },
      FA: function () {},
      Ek: function (t, i) {
      ...
      mi: function (t, i) {
        if ('opacity' in t.style) t.style.opacity = i
          ...
          for (var e = Math.round(100 * i),
                 n = 0; n < t.length; n += 1) t[n].childNodes && t[n].childNodes.length ? this.mi(t[n], i) : t[n].style && (t[n].style.filter = '', 100 !== e && (t[n].style.filter = ' progid:DXImageTransform.Microsoft.Alpha(opacity=' + e + ')'))
        }
      },
      fv: function (t) {
        for (var i = document.documentElement.style,
               e = 0; e < t.length; e += 1) if (t[e] in i) return t[e]
        return !1
      },
      iB: function (t) {
        var i = L.h.CQ
      ...
      IT: function (t, i, e) {
        t.Od = i,
          !e && L.h.HK ? (i = L.d.iB(i), e = t.style[L.d.Zc].split('rotate'), 1 < e.length ? (e[0] = i, t.style[L.d.Zc] = e.join('rotate')) : t.style[L.d.Zc] = i, L.h.ON && (t.style.WebkitBackfaceVisibility = 'hidden')) : (t.style.left = i.x + 'px', t.style.top = i.y + 'px')
      },
      dd: function (t) {
        return t.Od || (t.Od = t.style.left ? new L.Pixel(parseInt(t.style.left), parseInt(t.style.top)) : new L.Pixel(0, 0)),
          t.Od
      },
      GT: function (t, i) {
      ...
      pD: function (t, i) {
        return ';' !== i[i.length - 1] && (i += ';'),
          i.toLowerCase() !== t.style.cssText.replace(/ /g, '').toLowerCase() ? (t.style.cssText = i, !0) : !1
      },
      Z: function (t, i) {
        t = t instanceof Array ? t : [t]
        for (var e = 0; e < t.length; e += 1) for (var n in i) i.hasOwnProperty(n) && (t[e].style[n] = i[n])
        return this
      },
      SO: function (t) {
      ...
      rotate: function (t, i, e) {
        ...
        if (e = e || {
            ...
            n) {
          var s
          s = '' + (' translate(' + (e.x - t.clientWidth / 2) + 'px,' + (e.y - t.clientHeight / 2) + 'px)'),
            s = s + (' rotate(' + i + 'deg)') + (' translate(' + (t.clientWidth / 2 - e.x) + 'px,' + (t.clientHeight / 2 - e.y) + 'px)'),
            t.style[n] = s
        } else n = Math.cos(i * Math.PI / 180),
          i = Math.sin(i * Math.PI / 180),
          t.style.filter = 'progid:DXImageTransform.Microsoft.Matrix()',
        0 < t.filters.length && (t = t.filters.item(0), t.PQ = -e.x * n + e.y * i + e.x, t.QQ = -e.x * i - e.y * n + e.y, t.M11 = t.M22 = n, t.M12 = -(t.M21 = i))
      },
      VM: function (t, i, e) {
        var n = L.d.Zc
        if (e = e || {
            ...
            n) {
          var s
          return s = '' + (' translate(' + (e.x - t.clientWidth / 2) + 'px,' + (e.y - t.clientHeight / 2) + 'px)'),
            s = s + (' rotate(' + i + 'deg)') + (' translate(' + (t.clientWidth / 2 - e.x) + 'px,' + (t.clientHeight / 2 - e.y) + 'px)'),
          L.d.al[n] + ':' + s
        }
        return ''
      ...
      getElementsByClassName: function (t, i, e) {
        ...
        i = e.getElementsByTagName(i),
          t = RegExp('(^|\\s)' + t + '(\\s|$)'),
          e = []
        for (var n, s = 0; s < i.length; s++) n = i[s],
        t.test(n.className) && e.push(n);
        return e
      },
    ...
    function () {
      ...
      L.extend(L.d, {
        ...
        FA: function () {
          L.l.D(window, 'selectstart', L.l.preventDefault),
          i && 'none' !== t && (document.documentElement.style[i] = t, t = 'none')
        },
        SL: function () {
    ...
    L.d.nq = L.d.fv(['webkitTransition', 'transition', 'OTransition', 'MozTransition', 'msTransition']),
    L.d.ZQ = 'webkitTransition' === L.d.nq || 'OTransition' === L.d.nq ? L.d.nq + 'End' : 'transitionend',
    L.g.Qm = window.Qm ? window.Qm.bind(window) : function (t) {
      var i = Date.now()
    ...
    function (t) {
      var i = t.Class.extend({
        ...
        PA: function (t) {
          ...
          t = t.getLayers()
          for (var i = 0,
                 e = t.length; e > i; i++) if (t[i] && t[i] instanceof K) return t[i]
          return null
        },
        xM: function (t) {
          if (t = this.PA(t)) {
    ...
    L.Pixel = L.Class.extend({
      initialize: function (t, i, e) {
        if (isNaN(t) || isNaN(i)) throw 'Invalid Object: Pixel(' + t + ', ' + i + ')'
        this.x = e ? Math.round(t) : Number(t),
          this.y = e ? Math.round(i) : Number(i)
      },
      getX: function () {
        return this.x
      },
    ...
    L.PixelBounds = L.Class.extend({
      initialize: function () {
        if (2 === arguments.length) this.kb = arguments[0],
          this.Mb = arguments[1]
        else {
          ...
          this.kb = new L.Pixel(t[0], t[1]),
            this.Mb = new L.Pixel(t[2], t[3])
        }
      },
      getCenter: function (t) {
      ...
      contains: function (t) {
        var i
        return t instanceof L.PixelBounds ? (i = t.kb, t = t.Mb) : i = t,
        i.x > this.kb.x && t.x < this.Mb.x && i.y > this.kb.y && t.y < this.Mb.y
      },
      getWidth: function () {
    ...
    L.xn = L.Class.extend({
      ...
      sz: function (t, i) {
        return i = i || 1,
          t.x = i * (this.nw * t.x + this.uw),
          t.y = i * (this.xw * t.y + this.Pw),
          t
      },
      pQ: function (t, i) {
        return i = i || 1,
          new L.Pixel((t.x / i - this.uw) / this.nw, (t.y / i - this.Pw) / this.xw)
      }
    }),
    L.Dg = L.Class.extend({
      initialize: function (t) {
        this.gq = t.MAX_LATITUDE || 85.0511287798,
        t.project && t.unproject && (this.project = t.project, this.unproject = t.unproject)
      }
    }),
    L.Dg.Rv = {
      project: function (t) {
    ...
    L.Dg.XE = new L.Dg({
      ...
      project: function (t) {
        ...
        return t = t.B * i,
          i = Math.log(Math.tan(Math.PI / 4 + e * i / 2)),
          new L.Pixel(t, i, !1)
      },
      unproject: function (t, i) {
        var e = 180 / Math.PI
    ...
    L.Dg.Sv = {
      ...
      project: function (t) {
        ...
        return t = t.B * i * s,
          ...
          s = Math.sqrt(1 - s * s),
          n = s * Math.sin(i),
          n = Math.pow((1 - n) / (1 + n), .5 * s),
          i = -e * Math.log(Math.tan(.5 * (.5 * Math.PI - i)) / n),
          new L.Pixel(t, i)
      },
      unproject: function (t, i) {
        for (var e = 180 / Math.PI,
               n = this.jq,
               s = this.kq,
               o = t.x * e / n,
               n = s / n,
               n = Math.sqrt(1 - n * n), s = Math.exp(-t.y / s), a = Math.PI / 2 - 2 * Math.atan(s), r = 15,
               h = .1; 1e-7 < Math.abs(h) && (r -= 1, r > 0);) h = n * Math.sin(a),
          h = Math.PI / 2 - 2 * Math.atan(s * Math.pow((1 - h) / (1 + h), .5 * n)) - a,
          a += h;
    ...
    L.Pe.hn = {
      ...
      yu: function (t, i, e) {
        return i = this.scale(i),
          t = this.Zm.pQ(t, i),
          this.hd.unproject(t, e)
      },
      project: function (t) {
    ...
    L.S = {},
    L.S.ye = L.Class.extend({
      jb: [L.oa, L.Kc],
      initialize: function (t, i) {
        this.ec = t,
          this.vc = [3, 18],
          this.vq = L.g.Vb(this),
        t && this.cd(['opacity', 'visible', 'zIndex', 'zooms'], t),
          this.w = i,
          this.J('display', i)
      },
      ef: function () {
        ...
        var t = this.Ca
        if (t) {
          if (t.length) for (var i = 0; i < t.length; i += 1) t[i].parentNode && t[i].parentNode.removeChild(t[i]);
          else t.parentNode && t.parentNode.removeChild(t)
          this.Ca = null
        }
        this.ec.ef && this.ec.ef(),
          this.ec.Cf = !1,
          this.ec.S = null,
          this.bl(),
        this.P && (this.P.bl(), this.P.K = null, this.P.Un = null, this.P.w = null, this.P.bl(), this.P.Ew && this.P.Ew(), this.P = null)
      },
      ia: function (t, i) {
        this.ec.q(t, i)
      },
      ...
      opacityChanged: function () {
        ...
        if (this.opacity = Math.min(Math.max(0, t), 1), t = this.Ca) if (t.length) for (var i = 0; i < t.length; i += 1) this.Vu(t[i]);
        else this.Vu(t)
      },
      Yo: function () {
        ...
        if (t) {
          if (t instanceof L.Bounds) {
            var i = t.getNorthWest(),
              ...
              o = this.w.wb(e),
              a = this.w.get('center')
            i.B > e.B ? 0 < a.B ? o.x += n : s.x -= n : 0 < a.B ? (0 > i.B && (s.x += n), 0 > e.B && (o.x += n)) : (0 < i.B && (s.x -= n), 0 < e.B && (o.x -= n)),
              this.j = [s.x, s.y, o.x, o.y]
          }
          return t instanceof L.PixelBounds && (this.j = [t.kb.x, t.kb.y, t.Mb.x, t.Mb.y]),
            this.j
        }
        return null
      }
    ...
    L.nf = ec,
    L.S.of = L.S.ye.extend({
      r: function (t, i) {
        arguments.callee.Sa.apply(this, arguments),
          this.J('tileSize', t),
          this.J('tiles', t),
          this.cd(['zooms', 'type', 'detectRetina', 'tileFun', 'errorUrl'], t),
          this.J('lang', i, !0)
        var e = 'overlayer' === t.get('type')
        this.Sf = !e && !L.h.Y,
        (L.h.Oc || L.h.lU) && (this.Sf = !1)
        var n = i.get('size'),
          n = n.width * n.height / 65536
        L.h.sa && L.h.Y && n > 9 && (this.Sf = !1),
          this.Wf = !e,
          this.Xf = !e,
          this.J('reload', t)
      },
    ...
    L.S.Buildings = L.S.ye.extend({
      r: function (t, i) {
        this.map = i,
          ...
          this.uj = [],
          this.ne = new L.S.Hv,
        t && (this.J('style', t), this.WP = t.get('stable') || !1, this.J('dataSources', t), this.J('bubble', t)),
          this.J('display', i),
          this.AF()
      },
      ei: function () {
      ...
      dataSourcesChanged: function () {
        ...
        t && ('string' == typeof t ? new L.ga.pa(t).e('complete',
          function (t) {
            this.JC(t.data),
              this.dj = t.data,
              this.Jf = !0,
      ...
      rQ: function () {
        if (this.ec.dh) {
          var t = this.Pp
          this.tg = t.size.width + t.anchor.x,
            this.ug = t.size.height + t.anchor.y
        }
      },
      ia: function (t, i) {
        var e = {
        ...
        this.EH = 'mouseout' === t ? null : i.nk.lb,
          this.ec.q(t, e)
      },
      tR: function () {},
      $a: function (t) {
      ...
      AF: function () {
        this.e('click', this.$a),
          this.e('dblclick', this.$a),
          this.e('mousedown', this.$a),
          this.e('mouseup', this.$a),
          this.e('mouseover', this.$a),
          this.e('mouseout', this.$a),
          this.e('touchstart', this.$a),
          this.e('touchend', this.$a)
      },
      xR: function () {
        this.D('click', this.$a),
          this.D('dblclick', this.$a),
          this.D('mousedown', this.$a),
          this.D('mouseup', this.$a),
          this.D('mouseover', this.$a),
          this.D('mouseout', this.$a),
          this.D('touchstart', this.$a),
          this.D('touchend', this.$a)
      },
      styleChanged: function () {
        this.Pp = this.get('style'),
          this.rQ(),
          this.set('display', 0)
      },
      JC: function (t) {
        ...
        if (t) {
          ...
          if (t.rules) {
            for (var i = t.rules,
                   n = 0,
                   s = i.length; s > n; n += 1) {
              for (var o = [], a = i[n].symbolizers, r = 0,
                     h = a.length; h > r; r += 1) a[r].fill && (o[r] = new L.style.Bc.Iv(a[r].fill)),
              a[r].stroke && (o[r] = new L.style.Bc.Yv(a[r].stroke));
              a = o,
                i[n].Rp = a,
                i[n] = new L.style.SE(i[n])
            }
            e.rules = i
          }
          if (t.symbolizers) {
            for (i = t.symbolizers, t = 0, n = i.length; n > t; t += 1) i[t].fill && (i[t] = new L.style.Bc.Iv(i[t].fill)),
            i[t].stroke && (i[t] = new L.style.Bc.Yv(i[t].stroke));
            e.Rp = i
          }
          t = new L.mq(e)
        } else t = new L.mq({})
      ...
      wR: function (a, b) {
        if (-1 === L.g.indexOf(a, L.k.Va)) {
          ...
          c.e('complete',
            function (t) {
              t = this.Ua[a] = this.dB(b).wp(t),
                this.Ui(t),
                this.ia('complete')
            },
            this),
            c.e('error', this.Ka, this)
        } else new L.ga.XMLHttpRequest(a).e('complete',
          function (c) {
            c = eval('(' + c.data + ')'),
              c = this.Ua[a] = this.dB(b).wp(c),
              this.Ui(c)
          },
          this)
      },
      ...
      Ui: function (t) {
        this.Jf = !0
        for (var i = 0,
               e = t.length; e > i; i += 1) this.xo(t[i])
      },
      clear: function () {
        this.Jf = !0,
          this.ne.clear()
      ...
      vS: function (t) {
        var i, e = this.get('style'),
          n = t.Oe
        return e instanceof L.mq || (e = this.EO(e)),
          n && 0 < n.length ? i = e.pA(n, t) : ((e.kD.length || e.Oe.length) && (i = e.HL(t)), i || (i = t.DM())),
          i
      },
      kB: function (t) {
        function i (t, i) {
        ...
        for (e in t) if (t.hasOwnProperty(e)) {
          ...
          'undefined' == typeof h[o] && (r.push([[], [], o]), h[o] = r.length - 1),
            o = r[h[o]],
            o[0].push(s)
        }
    ...
    L.Lv = L.Class.extend({
      ...
      r: function (t, i, e) {
        this.timeout = i || 15e3,
          this.Bj = new L.Ad(1024),
          this.nh = new L.Ad(1024),
          this.nA = t,
          this.HA = e
      },
      zw: function (t) {
      ...
      qG: function (t) {
        ...
        i.src = t.url,
          ...
          t.Mu = !0,
          i.complete ? hc(t, !0) : (this.nh.set(t.url, t), i.onload = gc(t, !0), i.onerror = gc(t, !1), i.onabort = gc(t, !1), t.gQ = setTimeout(gc(t, !1), this.timeout))
      },
      ow: function (t) {
  ...
  var ic = function () {
      function t (t) {
        return this.rq[L.g.Vb(t)] = t,
          this
      }

      function i (t) {
        return delete this.rq[L.g.Vb(t)],
          this
      }
      ...
      return function () {
        function e () {
          ...
          for (n = s.length - 1; n >= 0; n -= 1) i = s[n].apply(this, arguments),
          void 0 !== i && (t = i);
          return t
        }
    ...
    canvasRenderer = {
      init: function (t, i) {
        this._map = t || this._map,
          this.La = new L.P.canvas.pf.Buildings,
          this.gE = i || 'vdata.amap.com',
          this.VD = 2,
          this.Zh = 0,
          this.yb = 256,
          this.S = L.h,
          this.S.VD = 2,
          this.Wm = [new L.Ad, new L.Ad, new L.Ad, new L.Ad, new L.Ad],
          this.Qf = [{
            type: 'region',
            show: !0,
            Pk: new L.aw(this),
          ...
          this.__isDrawLabel = !0,
        this._La && (this._La.__loadedImg__ = {}),
        this.Ti && this.size && (this.Ti.width = this.size.x, this.Ti.height = this.size.y)
      },
      _kt: function (t, i) {
        var e, n = '',
          s = []
        for (var o in t) e = o.split(':'),
          s.push(o),
          n += L.g.kt(e[0], e[1], e[2]) + ';';
      ...
      aE: function (t, i, e, n) {
        if ('first' === t) this.Wm[4].push(['co', 6, i])
          ...
          (0 === s || 4 === s || 1 !== t.length) && (this.Wm[s].ov(['co', s, i]), this.Qf[s].show && this.Wm[s].ov([t.slice(1), s, i]), this.Zh > s && (this.Zh = s)),
          3 === s && (this.Wm[3].ov(['co', 5, i]), 2 < this.Zh && (this.Zh = 2)),
            this.FD()
        }
      },
      FD: function () {
        this.IC || (this.IC = L.g.yg(function () {
            var t = new Date,
              i = !1
            do
              if (i = this.parse(), new Date - t >= this.zE) break
            while (!i)
            this.IC = null,
            i || this.FD(),
              this.yd()
      ...
      parse: function () {
        ...
        if (!n.Ik()) {
          ...
          if (6 === t[1]) {
            ...
            if ('co' === t[0]) {
              if (0 === t[1]) this.Cu(a),
              a.ce.region && 'v4' !== this.xQ || (r = this.La.tb.getContext('2d'), r.fillStyle = this.yF, r.fillRect(0, 0, a.Dc.width, a.Dc.height)),
              a.ce.region && (this.La.dD(a.ce.region, 0, a.ta.z), a.ce.region = null),
                a.X = !0,
              a.pb && (a.pb.X = !0)
              else if (2 === t[1] && a.ce && a.ce.building) this.Cu(a),
                this.La.dD(a.ce.building, 1, a.ta.z, void 0, undefined),
                a.ce.building = null
              else if (1 === t[1]) this.Cu(a),
              a.ce.road && (this.La.oP(a.ce.road, a.ta.z), a.ce.road = null),
                a.gg = !0,
              a.pb && (a.pb.gg = !0)
              else if (4 === t[1]) {
                if (r > 18) {
                  ...
                  a.eC = !0
                a.gg = !0,
                a.pb && (a.pb.Ab = !0, a.pb.eC = !0, a.pb.gg = !0)
              } else if (5 === t[1]) if (a.ce = null, a.X = !0, r > 18) for (t = a.ta, h = this.yb, o = Math.pow(2, r - 18), l = 0; o > l; l += 1) for (u = 0; o > u; u += 1)(c = this.Ba.get(r + ':' + (o * t.x + l) + ':' + (o * t.y + u))) && !c.X && (c.Dc = this.GL(), c.Dc.width = c.Dc.height = h, c.Dc.getContext('2d').drawImage(a.Dc, -l * h, -u * h), c.status = 'loaded', c.gg = !0, c.Ab = !0, c.X = !0, this.en && 0 === (c.ta.x + c.ta.y) % 2 && c.Dc.getContext('2d').drawImage(this.en, 0, 0))
              else this.en && 0 === (a.ta.x + a.ta.y) % 2 && a.Dc.getContext('2d').drawImage(this.en, 0, 0)
            } else r = this.Qf[t[1]],
              r.Pk.map = this.w,
              o = r.Pk.vu(a, t[0], r),
            3 !== t[1] && 4 !== t[1] && (a.ce[r.type] = o)
          }
          n.Ik() && (1 === e && 2 === e || !1)
        }
        return n.Ik() && (4 === e && (i = !0), this.Zh = (this.Zh + 1) % 5),
          i
      },
      Cu: function (t) {
        var i = 18 < t.hc ? Math.pow(2, 18 - t.hc) : 1
        t.Dc || (t.Dc = document.createElement('canvas'), t.Dc.width = t.Dc.height = this.yb / i, t.gg = !1),
          this.La.tb = t.Dc,
          this.La.nb = i
      },
      Zd: function (t, i, e, n, s, o, a) {
        this.Ca = this.Ca || t,
          this.Ti = this.Ti || i,
          this._La = this._La || new L.P.canvas.pf.Buildings(this.Ti),
          this._La.__isExtract = !0,
          this.K = {
            sa: this.S.sa,
            lf: !1,
            hf: 2
          ...
          this.rotation = 0,
          this.centerCoords = L.Pe.xE.hp(this.center, e).multiplyBy(this.L1),
          this.size = {
            width: n.x,
            height: n.y
          },
          this._tiles = s || this._tiles,
          this._La.__loadedImg__ = this._La.__loadedImg__ || {}
      },
      ...
      Bp: function (t) {
        ...
        0 !== t.va.rotation ? L.d.Rm(i, 2 * Math.floor(t.Ea.mb.x) * n, 2 * Math.floor(t.Ea.mb.y) * n, !0) : L.d.Rm(i, t.size.width * n, t.size.height * n, !0),
          e.Eb = [t.Ea.kb.x, t.Ea.kb.y],
          this._La.nb = this.L1 * (this.K.sa ? 1 / this.K.hf : 1)
        var s, o
        for (var a in this._tiles) if (s = a.split(':'), o = this.Ba.get(s[2] + ':' + s[0] + ':' + s[1]), o && (this.Hg = {
            ak: [o]
          },
          (i = this.Hg.ak) && i.length && !(.5 < i[0].ta.z - this.zoom))) for (e = i.length - 1; e >= 0; e -= 1) {
          var n = i[e].Ua,
            r = !1
          !n && i[e].pb && i[e].pb.Ua && (n = i[e].pb.Ua, r = !0),
            this._La.Bp(n || {})
        }
      },
      yd: function () {
        ...
        var t = {}
        t.size = this.size,
          t.SK = 15e5 < t.size.width * t.size.height,
          t.va = this.ZM(),
          t.qc = !1,
          t.lf = !1,
          t.iu = !1,
          ...
          this.Ym = !1,
          t.dC = !0,
          t.Ea = this.getCoordsBound(),
          t.Oz = this.Oz = !0,
          t.sa = !1,
          t.scale = Math.pow(2, t.va.zoom - t.va.xb),
          this.Bp(t)
      },
      ZM: function () {
        return {
  ...
  L.Ad = L.Class.extend({
    ...
    push: function (t) {
      t = new L.Ad.ui('', t),
        0 === this.count ? (this.hb.ya = null, t.ya = this.hb, this.hb.next = t) : (this.no.next = t, t.ya = this.no),
        this.count += 1,
        this.no = t
    },
    ov: function (t) {
      t = new L.Ad.ui('', t),
        0 === this.count ? (this.hb.ya = null, t.ya = this.hb, this.no = this.hb.next = t) : (this.hb.next.ya = t, t.next = this.hb.next, t.ya = this.hb, this.hb.next = t),
        this.count += 1
    },
    WN: function () {
      if (this.count) {
        this.count -= 1
        var t = this.hb.next
        return t.next ? (t.next.ya = this.hb, this.hb.next = t.next) : (this.hb.next = null, this.no = this.hb.ya = null),
          t.next = null,
          t.ya = null,
          t.value
      }
    ...
    wx: function (t) {
      this.Eq ? (t.next = this.hb.next, t.ya = this.hb, this.hb.next = t, t.next.ya = t) : (t.ya = this.hb.ya, t.next = this.hb, this.hb.ya = t, t.ya.next = t),
      this.Ki && this.uz(this.Ki)
    },
    uz: function (t) {
    ...
    Ly: function (t) {
      return this.hb !== t && this.Ql(t),
        t.value
    },
    clear: function () {
      this.w = {},
        this.hb = new L.Ad.ui('', null),
        this.hb.ya = this.hb.next = this.hb,
        this.count = 0
    }
  }),
    ...
    L.Ad.ui.prototype.ya = null,
    L.Ad.ui.prototype.next = null,
    L.Ad.ui.prototype.remove = function () {
      this.ya.next = this.next,
        this.next.ya = this.ya,
        this.next = this.ya = null
    },
    L.Ov = L.Class.extend({
      include: [L.oa],
      initialize: function (t) {
      ...
      forEach: function (t, i) {
        for (var e in this.de) if (this.de.hasOwnProperty(e) && !1 === t.call(i, this.de[e].el, e)) break
      },
      Qk: function (t, i) {
        return this.get(t, i)
      },
      set: function (t, i) {
        this.ac(t) ? this.de[t].el = i : (this.Fg += 1, this.de[t] = this.oF(i)),
        this.Fg > this.xq && this.pF()
      },
      ac: function (t) {
      ...
      pF: function () {
        if (this.Fg > this.xq * this.Sj.qt) this.sq(),
          this.mw()
      ...
      mw: function () {
        ...
        if (!(this.Fg < t)) for (var i, e, t = this.kF(this.Fg - t), n = 0, s = t.length; s > n; n += 1) i = t[n],
          e = this.cl(i),
          this.q ? this.q('drop', {
            key: i,
            el: e
    ...
    L.ze = L.Class.extend({
      r: function (t) {
        this.XB = 'undefined' != typeof t ? t : 6,
          this.op = Math.floor(this.XB / 2),
          this.Dp = {
            j: [1 / 0, 1 / 0, -(1 / 0), -(1 / 0)],
            qa: []
          },
      ...
      bp: function (t, i, e) {
        ...
        'undefined' != typeof e && (t.type = e),
          this.yB(t, this.Dp),
          this.count += 1
      },
      yB: function (t, i) {
        var e
        if (0 === i.qa.length) i.j = L.j.qb(t.j),
          i.qa.push(t)
        else {
          var n = this.mL(t, i),
            s = t
          do {
            if (e && 'undefined' != typeof e.qa && 0 === e.qa.length) {
              ...
              e = n.pop()
              for (var a = 0,
                     r = e.qa.length; r > a; a += 1) if (e.qa[a] === o || 0 === e.qa[a].qa.length) {
                e.qa.splice(a, 1)
                break
              }
            } else e = n.pop()
      ...
      GO: function (t) {
        for (var i = t.length - 1,
               ...
               n = t.length - 1,
               s = 0,
               o = t.length - 2; o >= 0; o -= 1) {
          var a = t[o]
          a.j[0] > t[e].j[0] ? e = o : a.j[2] < t[i].j[1] && (i = o),
            a.j[1] > t[s].j[1] ? s = o : a.j[3] < t[n].j[3] && (n = o)
        }
      ...
      HO: function (t, i, e) {
        for (var n, s, o, a = L.ze.Zk(i.j[2] - i.j[0], i.j[3] - i.j[1], i.qa.length + 1),
               r = L.ze.Zk(e.j[2] - e.j[0], e.j[3] - e.j[1], e.qa.length + 1), h = t.length - 1; h >= 0; h -= 1) {
          var l = t[h],
        ...
        a = t.splice(s, 1)[0],
          i.qa.length + t.length + 1 <= this.op ? (i.qa.push(a), L.j.extend(i.j, a.j)) : e.qa.length + t.length + 1 <= this.op ? (e.qa.push(a), L.j.extend(e.j, a.j)) : (o.qa.push(a), L.j.extend(o.j, a.j))
      },
      remove: function (t, i) {
        var e = []
        if (e[0] = {
          ...
          var n = 0,
            s = []
          do n = s.length,
            s = s.concat(this.$C.apply(this, e))
          while (n !== s.length)
          return s
        }
          ...
          if ('undefined' != typeof i) for (; r >= 0;) {
            ...
            if (L.j.intersects(t, h.j)) {
              if (i && 'undefined' != typeof h.pj && h.pj === i || !i && ('undefined' != typeof h.pj || L.j.oA(t, h.j))) {
                'undefined' != typeof h.qa ? (o = this.Yk(h, !0, [], h), e.qa.splice(r, 1)) : o = e.qa.splice(r, 1),
                  L.ze.Hu(e),
                  i = void 0,
                e.qa.length < this.op && (a = this.Yk(e, !0, [], e))
                break
              }
            ...
            a.length = 0,
              0 === n.length && 1 >= e.qa.length ? (a = this.Yk(e, !0, a, e), e.qa.length = 0, n.push(e), s.push(1)) : 0 < n.length && e.qa.length < this.op ? (a = this.Yk(e, !0, a, e), e.qa.length = 0) : a = void 0
          } else L.ze.Hu(e)
        } while (0 < n.length)
        return o
      },
    ...
    L.ra.Ah = L.Class.extend({
      ...
      Hq: function () {
        this.e('click', this.$a),
          this.e('rightclick', this.$a),
          this.e('dblclick', this.$a)
      },
      vz: function () {
        this.D('click', this.$a),
          this.D('rightclick', this.$a),
          this.D('dblclick', this.$a)
      },
      Jq: function () {
        this.get('clickable') && this.Hq(),
          this.e('mousemove', this.$a),
          this.e('mouseout', this.$a),
          this.e('mouseover', this.$a),
          this.e('mousedown', this.$a),
          this.e('mouseup', this.$a)
      ...
      IF: function () {
        this.get('clickable') && this.Hq(),
          this.e('touchstart', this.$a, this),
          this.e('touchmove', this.$a, this),
          this.e('touchend', this.$a, this)
      },
      Iq: function () {
        this.e('dragstart', this.Ni),
          this.e('dragging', this.Li),
          this.e('dragend', this.Mi)
      },
      Ni: function (t) {
        this.re = t.sb,
          this.ia('dragstart', t)
      ...
      Sr: function () {
        this.D('dragstart', this.Ni),
          this.D('dragging', this.Li),
          this.D('dragend', this.Mi)
      },
      fx: function (t) {
        var i, e, n = []
    ...
    L.ra.Wc = L.ra.Ah.extend({
      ...
      r: function (t, i) {
        arguments.callee.Sa.apply(this, arguments),
          ...
          this.ZK(),
          this.Wi(),
          this.set('AnimationOffset', new L.Pixel(0, 0)),
          this.J('raiseOnDrag', t),
          this.GK = {
      ...
      lh: function (t) {
        ...
        t = this.map.wb(i).add(t.multiplyBy(this.map.get('resolution'))),
          i instanceof L.LngLat ? this.set('position', this.map.je(t)) : this.set('position', t)
      },
      ZK: function () {
        ...
        this.set('contentDom', t),
        i && (i = this.Wz(i, e), this.set('shadowDom', i)),
        n && n.content && this.set('labelDom', this.Vz(n.content))
      },
      Vz: function (t) {
        var i = document.createElement('div')
        return i.className = 'amap-marker-label',
          i.innerHTML = t,
          i
      },
      Wi: function () {
      ...
      iconChanged: function () {
        if (this.A && this.A.O && !this.get('content')) {
          this.map.Tb.um = !0,
            this.map.Tb.Nk.push(this.A),
          this.A.O && this.get('contentDom') && this.A.O.removeChild(this.get('contentDom'))
          var t = this.get('icon'),
            i = this.get('offset'),
            t = this.Rs(t, i)
          this.set('contentDom', t),
        ...
        if (this.A && this.A.O) {
          ...
          if (this.A.O && t && t.parentNode === this.A.O && this.A.O.removeChild(t), t = this.get('shadow')) {
            var i = this.get('offset'),
              t = this.Wz(t, i)
            this.set('shadowDom', t),
            this.A.O && this.A.O.appendChild(t)
          }
        }
      },
          ...
          if (i && t && t.hasOwnProperty('content')) {
            ...
            if (t.content) {
              var e = this.Vz(t.content),
                n = 0,
                s = 0
              t.offset && (n = t.offset.y + 'px', s = t.offset.x + 'px'),
                e.style.top = n,
                e.style.left = s,
                i.appendChild(e)
            }
      ...
      opacityChanged: function () {
        ...
        t && L.d.mi(t, this.get('opacity')),
        i && L.d.mi(i, this.get('opacity'))
      },
      Uz: function (t) {
        var i
        return i = document.createElement('div'),
          i.className = 'amap-marker-content',
          'string' != typeof t ? i.appendChild(t) : (i.innerHTML = t, i.childNodes[0] && !i.childNodes[0].style && (i.style['white-space'] = 'pre')),
          L.d.mi(i, this.get('opacity')),
          i
      },
      Rs: function (t) {
        var i, e, n, s, o, a = 0,
        ...
        return t ? ('string' == typeof t ? (i = t, o = !0) : (i = t.get('image'), r = t.get('size'), e = t.get('imageSize'), a = r.width, r = r.height, e && (n = e.width, s = e.height)), a || (a = 0), r || (r = 0), t = 'string' != typeof t ? t.get('imageOffset') : {
          ...
          e.style.position = 'absolute',
        o && !L.h.Oc && (e.style.overflow = 'inherit'),
        a && (e.style.width = a + 'px'),
        r && (e.style.height = r + 'px'),
          a = document.createElement('img'),
          a.src = i,
        n && s && (a.style.width = n + 'px', a.style.height = s + 'px'),
          a.style.top = t.y + 'px',
          a.style.left = t.x + 'px',
        L.h.Oc && o || e.appendChild(a),
          L.d.mi(L.h.Oc && o ? a : e, this.get('opacity')),
          L.h.Oc && o ? a : e
      },
      Wz: function (t, i) {
        var e = this.Rs(t, i)
        return e.style.zIndex = -1,
          e
      },
      ...
      moveTo: function (t, i, e) {
        ...
        return 0 === s ? this.q('moveend') : (this.df && (this.df.stop(), this.df = null), this.df = new L.Bg(n, t), e = e ||
          function (t) {
            return t
          },
          this.df.transition = function (t, i, n) {
            ...
            return t = (i.G - t.G) * e(n / s) + t.G,
              new L.LngLat(o, t)
          },
          this.df.Im = function (i) {
            this.set('position', i),
              i.equals(t) ? (this.df && (this.df.stop(), this.df = null), this.zc.q('moveend'), this.q('moveend')) : this.zc.q('moving')
          },
      ...
      SN: function (t, i, e, n) {
        function s () {
          o += 1,
            o < t.length ? this.moveTo(t[o], i, e) : (this.ia('movealong'), n ? (o = 1, this.set('position', t[0]), this.moveTo(t[1], i, e)) : this.D('moveend', s, this))
        }

        var o = 0
        this.set('position', t[0]),
          this.e('moveend', s, this),
          this.e('movestop',
            function () {
      ...
      PG: function (t, i) {
        ...
        var o = e.y - n.y,
          a = e.x - n.x
        return 0 !== e.x - n.x ? (s = Math.atan((e.y - n.y) / (e.x - n.x)), o >= 0 && 0 > a ? s = Math.PI + s : 0 > o && 0 >= a ? s = Math.PI + s : 0 > o && a >= 0 && (s = 2 * Math.PI + s)) : s = e.y > n.y ? Math.PI / 2 : 3 * Math.PI / 2,
          L.g.Ff(180 * s / Math.PI, 1)
      }
    }),
    L.ra.cq = L.ra.Ah.extend({
      ...
      lC: function () {
        this.Zd(),
          this.dl(),
          this.uh(),
          this.map.e('movestart', this.uf, this),
          this.map.e('mapmove', this.uf, this),
          this.map.e('zoomstart', this.uf, this),
          this.map.e('click', this.uf, this),
          this.map.e('closeOverlays', this.uf, this),
          this.map.e('rotate', this.uf, this)
      },
      uf: function () {
      ...
      Zd: function () {
        ...
        L.l.e(t, 'mousedown',
          ...
          this),
          this.u = t,
          this.map.Ra.ra.appendChild(this.u)
      },
      dl: function () {
        var t = this,
          i = this.u
      ...
      uh: function () {
        ...
        if (t && i) {
          ...
          this.u.style.right = '',
            this.u.style.bottom = '',
            this.u.style.left = i + 'px',
            this.u.style.top = e + 'px'
        }
      },
      ef: function () {
    ...
    L.ra.yh = L.ra.Ah.extend({
      r: function (t, i) {
        arguments.callee.Sa.apply(this, arguments),
          this.cd('content position contentU isCustom autoMove showShadow closeWhenClickMap size offset'.split(' '), t),
          this.J('resolution', i),
          this.J('centerCoords', i),
          this.J('retainWhenClose', t, !0),
          this.J('display', i),
          t.J('toBeClose', this),
          this.map = i,
          this.Ug = t
      ...
      lC: function () {
        this.zL ? this.map.Ra.ra.appendChild(this.Ia) : (this.Zd(), this.dl(), this.uL()),
          this.rv(),
          this.uh(),
          this.pw(),
          this.zL = !0
      ...
      Zd: function () {
        ...
        t.style.position = 'absolute',
          e.style.position = 'absolute',
          e.style.bottom = -1 * (this.get('offset').y || 0) + 'px',
          e.style.left = (this.get('offset').x || 0) + 'px',
          i.style.position = 'absolute',
          i.style.bottom = -1 * (this.get('offset').y || 0) + 'px',
          i.style.left = (this.get('offset').x || 0) + 'px',
          this.Ia = t,
          this.Rb = e,
          this.Sm = i,
          this.Td = n,
      ...
      dl: function () {
        ...
        if (t) {
          ...
          } else s = n = L.d.create('div', e, 'amap-info-content amap-info-outer'),
            'string' == typeof t ? n.innerHTML = t : n.appendChild(t),
            this.AL = n,
            t = L.d.create('a', this.Td, 'amap-info-close'),
            t.innerHTML = '\\u00d7',
            this.Vs = t,
            t.href = 'javascript: void(0)',
            L.h.uc ? (L.l.e(t, 'touchstart',
              function (t) {
                L.l.stop(t)
              },
              this), L.l.e(t, 'touchend',
              function (t) {
                L.l.stop(t),
                  this.Ug.close()
              },
              ...
              this)),
          (t = this.get('size', !0)) && (0 !== t.width && (n.style.width = t.width + 'px'), 0 !== t.height && (n.style.height = t.height + 'px')),
            t = L.d.create('div', e, 'amap-info-sharp'),
            t.style.height = '23px',
          (L.h.td || L.h.zm) && (t.style.marginLeft = e.childNodes[0].offsetWidth / 2 - 5),
      ...
      rv: function () {
        ...
        if (!t && i) {
          var t = this.Sm,
            ...
            e = i.height - 23,
            n = i.width;
          (L.h.td || L.h.zm) && (e = this.Td.childNodes[0].offsetHeight, n = this.Td.childNodes[0].offsetWidth + 26),
            i = 'background-image:url(' + L.k.Va + (L.h.td ? '/theme/v1.3/iws.gif);' : '/theme/v1.3/iws.png);'),
            t.innerHTML = ''
          var s, o = []
          for (s = o[1] = {},
                 s.height = .5 * e + 4, s.width = n, s.offsetX = 400, s.offsetY = 16, s.top = -s.height - 10 - 15, s.left = 23, s = o[2] = {},
                 s.height = o[1].height, s.width = o[1].height, s.offsetX = 1075 - s.width, s.offsetY = o[1].offsetY, s.top = o[1].top, s.left = 23 + o[1].width, s = o[3] = {},
                 s.height = 10, s.width = 22, s.offsetX = 30, s.offsetY = 445, s.top = -25, s.left = 23 + (L.h.zm || L.h.td ? 5 : 0), s = o[4] = {},
                 s.height = 10, s.width = n / 2 - 15 - o[3].left - o[3].width, s.offsetX = 132, s.offsetY = 445, s.top = -25, s.left = o[3].left + o[3].width, s = o[5] = {},
                 s.height = 10, s.width = 70, s.offsetX = 80, s.offsetY = 445, s.top = -25, s.left = o[4].left + o[4].width, s = o[6] = {},
                 s.height = 10, s.width = n - o[5].left - o[5].width, s.offsetX = 132, s.offsetY = 445, s.top = -25, s.left = o[5].left + o[5].width, s = o[7] = {},
                 s.height = 10, s.width = 30, s.offsetX = 621, s.offsetY = 445, s.top = -25, s.left = n, s = o[8] = {},
                 s.height = 15, s.width = 70, s.offsetX = 47, s.offsetY = 470, s.top = -15, s.left = n / 2 - 15, e = 1; 8 >= e; e += 1) n = L.d.create('div', t),
            s = [],
            s.push('position:absolute;'),
            s.push(i),
            s.push('top:' + o[e].top + 'px;'),
            s.push('left:' + o[e].left + 'px;'),
            s.push('width:' + o[e].width + 'px;'),
            s.push('height:' + o[e].height + 'px;'),
            s.push('background-position:' + -o[e].offsetX + 'px ' + -o[e].offsetY + 'px;'),
      ...
      gG: function () {
        ...
        return this.get('isCustom') || (t = t.add(new L.Pixel(0, -23))),
          t.add(i)
      },
      pw: function () {
        if (this.get('position') && this.get('autoMove') && this.Td) {
          ...
          for (var e = t.lnglatTocontainer(this.get('position')).add(this.gG()), n = e.add(i.$k()), s = t.get('size'),
                 o = t.AM(), a = 0, r = 0, h = 0; h < o.length; h += 1) {
            var l = o[h],
              u = 0,
              c = 0
          ...
          e = e.add(new L.Pixel(a, r)),
            n = n.add(new L.Pixel(a, r)),
            h = o = 0,
            0 > e.x || i.getWidth() > s.getWidth() ? o = 20 - e.x : s.getWidth() < n.x && (o = s.getWidth() - n.x - 25),
            0 > e.y || i.getHeight() > s.getHeight() ? h = 5 - e.y : s.getHeight() < n.y && (h = s.getHeight() - n.y - 15),
            o += a,
            h += r,
          (o || h) && t.Fb.panBy(o, h)
        }
      ...
      mR: function () {
        ...
        for (var t = this.Ce,
               i = t.firstChild,
               e = t.lastChild; i && e && i.style && e.style && i === e;) t = i,
          i = t.firstChild,
          e = t.lastChild;
        return t = L.d.gc(t, 'width'),
      ...
      offsetChanged: function () {
        ...
        this.Rb.style.bottom = -1 * (t.y || 0) + 'px',
          this.Rb.style.left = (t.x || 0) + 'px',
          this.Sm.style.bottom = -1 * (t.y || 0) + 'px',
          this.Sm.style.left = (t.x || 0) + 'px'
      },
      contentChanged: function () {
        this.dl(),
          this.rv(),
    ...
    L.W.si = L.Class.extend({
      ...
      FP: function (t) {
        if (this.vj = this.getBounds(), this.Mc = null, L.W.Xc && this instanceof L.W.Xc) {
          var i = t.length
          this.ue = Array(i)
          for (var e, n, s = 0; i > s; s += 1) if (e = t[s], n = new L.W.Qv(e), this.ue[s] = n, 0 === s) {
            if (0 === e.length) break
            n.oj(e) || e.reverse()
    ...
    L.kd = L.Class.extend({
      ...
      UL: function () {
        this.style = this.Oe = this.Mh = this.NB = this.ja = this.name = this.map = null,
          this.bl(),
          this.tk()
      },
      XM: function () {
      ...
      MP: function (t) {
        this.Oe = t,
          this.zIndex = this.Oe[0].xe || this.zIndex
      },
      uS: function () {
        return this.ja
      },
    ...
    L.P.ye = L.Class.extend({
      ...
      yt: function (t, i) {
        ...
        if (Math.floor(e) !== e) i(n, s)
          ...
          if (e = [t.x, t.y], s.um) {
            for (var o = s.Nk,
                   a = !0,
                   r = [], h = 0; h < o.length; h += 1) {
              var l = o[h].Xh
              if (l) {
                var u = l.clientWidth,
                  c = l.clientHeight
                l.childNodes[0] && (u = u || l.childNodes[0].clientWidth, c = c || l.childNodes[0].clientHeight),
                window.opera && (u = Math.max(u, l.childNodes[0].scrollWidth), c = Math.max(c, l.childNodes[0].scrollHeight)),
                  0 === u || 0 === c ? (a = !1, r.push(o[h])) : (s.tg = Math.max(s.tg, Math.abs(o[h].get('offset').x) + u), s.ug = Math.max(s.ug, Math.abs(o[h].get('offset').y) + c), o[h].width = u, o[h].height = c)
              }
            }
          ...
          if (o = Math.max(s.tg, s.Mk || 0) * this.L1, a = Math.max(s.ug, s.Mk || 0) * this.L1, a = Math.max(a, s.jh || 0), o = Math.max(o, s.jh || 0), o = s.Gf([e[0] - o, e[1] - a, e[0] + o, e[1] + a])) {
            for (var d in o) if (o.hasOwnProperty(d) && (a = o[d], a.get('visible') && !a.get('noSelect'))) if (h = a.ja, h instanceof L.W.Bd) {
              if (this.dh) {
                var r = this.K.Pp,
              ...
              } else if ('undefined' != typeof h.get('radius')) r = h.Ta,
                r = new L.Pixel(r[0], r[1]),
              new L.Pixel(e[0], e[1]).distance(r) * Math.cos(a.get('center').G * Math.PI / 180) <= h.get('radius') && n.push(a)
                ...
                if (h = h.Ta, p = r.Kz % 360, l = [e[0], e[1]], p) {
                  var u = (e[0] - h[0]) / this.L1,
                    ...
                    f = Math.sin(-f),
                    m = u * f + c * p
                  l[0] = h[0] + (u * p - c * f) * this.L1,
                    l[1] = h[1] + m * this.L1
                }
                for (u = a.width * this.L1, c = a.height * this.L1, p = r.offset.x * this.L1, f = r.offset.y * this.L1, u = L.j.Rz([[l[0] - u - p, l[1] - c - f], [l[0] - p, l[1] - f]]), h[0] instanceof Array || (h = [h]), c = h.length - 1; c >= 0; c -= 1) if (L.j.ge(u, h[c])) {
      ...
      oN: function (t, i, e) {
        ...
        if (t = t.shape, 'circle' === t.F.type) {
          ...
          if ('poly' === t.F.type) return s = t.F.coords,
            s = this.eL(s),
            L.wh.ge(n, s)
          if ('rect' === t.F.type) return s = t.F.coords,
            t = s[0],
            i = s[1],
            e = s[2],
            s = s[3],
      ...
      zt: function (t, i, e, n, s, o, a) {
        ...
        r.push('top:' + Math.round(e) + 'px;'),
          r.push('left:' + Math.round(i) + 'px;'),
          r.push('width:' + Math.round(n) + 'px;'),
          r.push('height:' + Math.round(s) + 'px;'),
        1 > o && ('opacity' in t.style ? (r.push('opacity'), r.push(':'), r.push(o), r.push(';')) : 8 <= document.documentMode ? (r.push('-ms-filter:\'progid:DXImageTransform.Microsoft.Alpha(opacity='), r.push(Math.ceil(100 * o)), r.push(')\';')) : (r.push('filter:alpha(opacity='), r.push(Math.ceil(100 * o)), r.push(');'))),
          r.push('z-index:' + a + ';'),
          L.d.pD(t, r.join(''))
      }
    }),
    L.P.Ld = L.Class.extend({
      ...
      r: function (t) {
        this.w = t,
          ...
          this.u = t.Ra.S,
          this.J('display', t),
          this.J('rotateEnable', t)
      },
      yt: function (t, i, e, n) {
        function s (t, n) {
          t.length && (r[L.g.indexOf(i, n)] = t),
            h -= 1,
          0 >= h && (e(r), h = 0)
        }

        for (var o, a = i.length,
               r = [], h = 0, l = [], u = 0; a > u; u += 1) o = i[u],
        o instanceof L.S.Buildings && o.get('visible') && (l.push(this.At(o)), h += 1);
    ...
    L.P.canvas.Ld = L.P.Ld.extend({
      ...
      At: function (t) {
        var i = L.g.Vb(t)
        return this.Br[i] || (this.Br[i] = t.P = t.Yh(this)),
          this.Br[i]
      },
      yd: function (t) {
        ...
        for (var i = t.vb,
          ...
          var a = i[o],
            a = this.At(a),
            r = i[o].ei()
          if (a) if (!r.visible || r.vc[0] > e.zoom || r.vc[1] < e.zoom) if (a = a.Hf(), a.length) for (r = 0; r < a.length; r += 1) a[r].parentNode === this.u && this.u.removeChild(a[r]);
            ...
            if (c && u) {
              ...
              for (var d = 0; d < u.length; d += 1) {
                ...
                1e-5 > Math.abs(f) && (f = 0)
                var _ = []
                _.push('position:absolute'),
                  _.push('z-index:' + (l.xe || i[o].get('zIndex'))),
                  i[o].Ro ? (_.push('top:' + Math.floor(s / 2 + f) + 'px'), _.push('left:' + Math.floor(n / 2 + p) + 'px')) : h.getContext ? (_.push('height:' + Math.floor(h.height * m) + 'px'), _.push('width:' + Math.floor(h.width * m) + 'px'), _.push('top:' + Math.floor(s / 2 - f * m) + 'px'), _.push('left:' + Math.floor(n / 2 - p * m) + 'px')) : (1 !== m && (_.push(L.d.al[L.d.Zc] + '-origin:' + p + 'px ' + f + 'px'), _.push(L.d.al[L.d.Zc] + ':scale3d(' + m + ',' + m + ',1)')), _.push('top:' + Math.floor(s / 2 - f) + 'px'), _.push('left:' + Math.floor(n / 2 - p) + 'px')),
                !a.ep && 1 !== r.opacity && 'number' == typeof r.opacity && 'opacity' in h.style && _.push('opacity:' + r.opacity),
                (h.parentNode !== this.u || L.h.Sd) && this.u.appendChild(h),
                  L.d.pD(h, _.join(';'))
              }
        ...
        t = this.w.Ra.Sh,
          a = this.w.Ra.S,
          i = this.w.Ra.ra,
          L.d.Zc && 'number' == typeof e.rotation && 0 !== e.rotation ? (t.style[L.d.Zc + 'Origin'] = n / 2 + 'px ' + s / 2 + 'px', t.style[L.d.Zc] = 'rotate(' + e.rotation + 'deg)', t.style.overflow = 'visible', a.style.overflow = 'visible', i.style.overflow = 'visible') : (t.style.cssText = '', a.style.cssText = '-webkit-transform: translateZ(0);', i.style.cssText = ''),
          this.w.Mp = !1
      }
    }),
    L.P.Eg = L.P.ye.extend({
      initialize: function (t, i) {
        ...
        this.Ba.e('drop',
          ...
          this.qw = !0,
          this.K.Ba = this.Ba,
          this.Qt = new L.Lv(6, null, t.HA),
          new L.Lv(5, null, t.HA)
      },
      reloadChanged: function () {
        this.K && (this.K.Ab = !1),
          this.Ba.clear(),
            ...
            t.Jk = i.QB(t.url,
              function (i) {
                t.Jk = null,
                  t.loaded = !0,
                  e.Ba.set(t.key, t),
                i && e.K && (t.X = i, t.Jk = null, e.set('display', 0), e.Lk += 1, e.K.Ab || e.Lk !== e.ip || (e.K.Ab = !0, e.K.ia('complete')))
              },
              !1)
        }
      },
      cE: function (t, i, e, n) {
        ...
        for (var o = 0; o < t.length; o += 1) {
          var a = t[o].ta,
            r = Math.floor(a.x / i),
            a = Math.floor(a.y / i)
          n ? (r = e + '/' + r + '/' + a, a = this.Ba.get(r)) : (a = new L.nf(e, r, a), r = a + '', a = new L.of(a)),
          !s[r] && a && (s.push(a), s[r] = 1)
        }
        return s
      },
      SB: function (t) {
        for (var i = t.length - 1; i >= 0; i -= 1) {
          ...
          if (e.length) if (this.Hc) {
            ...
            n > 18 && (e = this.cE(e, n)),
              this.DD(e, !0)
            for (var s = 0,
                   o = 0; s < t.length;) this.HN(e.slice(30 * o, 30), n),
              s += 30,
              o += 1
          } else for (this.DD(e), this.ip += e.length, n = e.length - 1; n >= 0; n -= 1) this.RB(e[n], this.Qt)
        }
      },
      Ft: function (t, i) {
        var e = t + ''
      ...
      Xs: function (t, i, e) {
        ...
        var o = i.Mb.y,
          a = i.kb.x
        return i = i.kb.y,
          this.Sp = new L.Pixel(0, 0),
          n = this.Tm(this.zoom, n) * s,
          n /= Math.pow(2, this.De),
        e && (a = Math.max(e[0], a) - e[0], i = Math.max(e[1], i) - e[1], t = Math.min(e[2], t) - e[0], o = Math.min(e[3], o) - e[1], this.Sp = new L.Pixel(Math.floor(e[0] / n), Math.floor(e[1] / n))),
          t /= n,
          o /= n,
          e = {
      ...
      Du: function (t, i) {
        i.af !== this.af && (this.af = i.af, this.Ba.clear()),
          this.clear(),
          this.Xf = i.Xf,
          this.Wf = i.Wf,
          this.yb = i.yb
        var e = t.va
        this.hd = i.hd || t.va.hd,
          this.Th = e.Th,
          this.size = t.size,
          this.rotation = e.rotation,
          this.fb = e.fb,
          this.nb = e.nb,
          this.De = (this.io = L.h.Y && i.sa && !i.wN) ? 1 : 0,
          this.zoom = e.zoom,
          this.ad = this.xb = e.xb,
          this.ad += this.De,
          this.L1 = e.L1,
          t.scale = Math.pow(2, this.zoom - this.xb)
        var n
        ...
        var s, o, a, r, h, l, u, c, e = this.Rc = this.Xs(e, n, i.j),
          ...
          y = {},
          b = {}
        for (this.Uc = 1e6 * Math.random() << 0, o = m.length - 1; o >= 0; o -= 1) if (s = m[o], !(s.ol < i.opacity)) if (g.z = s.ta.z, g.x = s.ta.x, g.y = s.ta.y, g.z === this.ad) y[g + ''] |= 16
        else if (g.z < this.ad) {
          if (y[g + ''] |= 64, this.Xf) for (c = this.ad - g.z, a = Math.max(e.te, g.x << c), v = Math.min(e.ae, (g.x + 1 << c) - 1), r = Math.max(e.gd, g.y << c), h = Math.min(e.ud, (g.y + 1 << c) - 1), g.z = this.ad, l = a; v >= l; l += 1) for (g.x = l, u = r; h >= u; u += 1) g.y = u,
            c = g + '',
            y[c] |= 32,
            b[c] = b[c] ? Math.max(s.ta.z, b[c]) : s.ta.z
        } else if (this.Wf) for (c = 1; g.z >= this.ad;) {
          for (y[g + ''] |= c, a = g.x >> 1, r = g.y >> 1, v = a << 1, h = r << 1, s = 0, l = 2; l > 0; l -= 1) for (g.x = v + l, u = 2; u > 0; u -= 1) g.y = h + u,
          5 & y[g + ''] && (s += 1)
          g.z -= 1,
            g.x = a,
            g.y = r,
        ...
        for (m = [], g.z = this.ad, l = e.te; l <= e.ae; l += 1) for (g.x = l, u = e.gd; u <= e.ud; u += 1) g.y = u,
          s = this.Ft(g),
          c = g + '',
          a = !1,
          s.X ? t.qc && this.Hc && !s.gg ? a = !0 : (s.Uc = this.Uc, m.push(s), c = y[c], 36 & c ? (s.Pb !== this.Pb || 1 > s.ol) && (a = !0) : s.Jl = !0) : (a = !0, !s.status && g.z <= i.vc[1] + this.De && f.push(s)),
        a && _.push(s)
        if (m.hc = this.xb, m.length && (d.push(m), d['lv' + this.xb] = m), p.push(f), p['lv' + this.xb] = f, this.Wf) {
          for (_ = _.slice(0), f = [], o = _.length - 1; o >= 0; o -= 1) s = _[o],
          4 & y[s.key] || f.push(s);
          for (s = i.vc[1] + this.De, v = this.ad + 1; _.length && s >= v; v += 1) {
            for (m = [], h = _, _ = [], g.z = v, o = h.length - 1; o >= 0; o -= 1) if (l = h[o], c = y[l.key], 7 & c) for (a = l.ta.x << 1, r = l.ta.y << 1, l = 2; l > 0; l -= 1) for (g.x = a + l, u = 2; u > 0; u -= 1) {
              g.y = r + u,
                c = g + ''
              var x = this.Ba.Qk(c)
        ...
        if (this.Xf) for (l = Math.max(i.vc[0], this.ad - 3), u = Math.max(l, this.ad - this.oR), v = this.ad - 1; _.length && v >= l; v -= 1) {
          for (r = v >= u, f = [], m = [], x = {},
                 h = _, _ = [], o = h.length - 1; o >= 0; o -= 1) s = h[o],
            g.z = v,
            g.x = s.ta.x >> 1,
            g.y = s.ta.y >> 1,
            s = this.Ft(g, !r),
          x[s.key] || (x[s.key] = 1, a = !1, s.X && (!this.uR || 64 & y[s.key]) ? (g.x = Math.min(e.ae, Math.max(e.te, g.x << this.ad - v)), g.y = Math.min(e.ud, Math.max(e.gd, g.y << this.ad - v)), g.z = this.ad, c = g + '', 'number' == typeof b[c] && s.ta.z > b[c] ? a = !0 : (s.Jl = !0, s.Uc = this.Uc, m.push(s))) : (a = !0, r && !s.status && f.push(s), a && _.push(s)));
          m.length && (d.push(m), m.hc = v - this.De, d['lv' + (v - this.De)] = m, this.Hc && this.aD(m, d, this.ad - v)),
          r && f.length && (p.push(f), p['lv' + (v - this.De)] = f)
        }
        this.Lk = this.ip = 0,
        this.Hc && !t.dC || this.SB(p, n),
          this.jv = d,
          this.K.set('tiles', d)
      },
      aD: function (t, i, e) {
        for (var n = 0; n < t.length; n += 1) for (var s = t[n].ta, o = s.z + e, a = Math.pow(2, e), r = s.x * a,
                                                     s = s.y * a,
                                                     h = 0; a > h; h += 1) for (var l = 0; a > l; l += 1) {
          var u = this.Ba.get(o + '/' + (r + h) + '/' + (s + l))
          if (u && i['lv' + (o - this.De)]) {
            var c = i['lv' + (o - this.De)].indexOf(u);
            -1 !== c && u.X && !u.gg && i['lv' + (o - this.De)].splice(c, 1)
          }
        }
      },
      rT: function () {
        ...
        for (var o = [], a = e; t >= a; a += 1) {
          s.x = a
          for (var r = n; i >= r; r += 1) s.y = r,
          this.Ba.Qk(void 0) || (e = new L.of(s.qb(), this.af(s.x, s.y, s.z)), o.push(e))
        }
        this.SB([o])
      }
    }),
    L.P.$b.Eg = L.P.Eg.extend({
      ...
      Dj: function () {
        if (this.Hg) for (var t = 0; t < this.Hg.length; t += 1) {
          ...
          if (i.X && this.Uc !== i.Uc && this.Ca === i.X.parentNode) {
            if (L.h.td && i.X.vml) for (var e in i.X.vml) i.X.vml.hasOwnProperty(e) && this.Ca === i.X.vml[e].shape.parentNode && this.Ca.removeChild(i.X.vml[e].shape);
            ...
            if ((Math.ceil(s) < this.Rc.te || Math.floor(s) > this.Rc.ae || Math.ceil(n) < this.Rc.gd || Math.floor(n) > this.Rc.ud) && i.X && this.Ca === i.X.parentNode) {
              if (L.h.td && i.X.vml) for (var o in i.X.vml) i.X.vml.hasOwnProperty(o) && this.Ca === i.X.vml[o].shape.parentNode && this.Ca.removeChild(i.X.vml[o].shape);
              this.Ca.removeChild(i.X),
                i.zoom = null
            }
          }
      ...
      yd: function (t, i) {
        if (t.Up || t.kv) this.Jc(t, i, !0)
          ...
          this.Du(t, i)
          var e = !1;
          (!this.ba || 3e4 < Math.abs(this.fb.x - this.ba.x) / this.L1 || 3e4 < Math.abs(this.fb.y - this.ba.y) / this.L1) && (e = !0),
          (e || this.zoom << 0 !== this.zoom || this.Jd !== this.zoom) && (this.ba = this.fb, this.Jd = this.zoom)
          var e = !1,
            n = +new Date,
            s = i.opacity
          'opacity' in this.Ca.style && (s = 1),
            this.Sf = i.Bo
          var o = [],
            a = this.Pb
          this.Pb += 1
          var r = this.jv
          if (this.Dj(), L.h.td && 'overlayer' === this.K.get('type') && this.Ca && t.lf) this.Ca.innerHTML = '',
            this.Hg = []
          else {
  ...
  window.CanvasRenderingContext2D && (window.CanvasRenderingContext2D.prototype.at = function (t, i, e, n, s) {
    ...
    n = o / r,
      e = a / r,
      s.Zt = 0
    for (var h = [], o = this.Oo, l = 0, u = 0, c = !1, d = a = 0; d < s.length; d += 1) s.Zt += s[d],
      h[d] = {
        ht: s[d] * n,
        it: s[d] * e,
        $d: a += s[d]
      ...
      o -= s[d],
    0 > o && !c && (l = d, u = -o, c = !0);
    for (c = 0; r >= u + c;) u < s[l] ? (o = u * n, a = u * e) : (o = h[l].ht, a = h[l].it),
      t += o,
      i += a,
      this.Um ? this.moveTo(t, i) : this.lineTo(t, i),
      c += u,
      this.Um = !this.Um,
      u = s[(l + 1) % s.length],
      l = (l + 1) % s.length;
    ...
    window.CanvasRenderingContext2D.prototype.KL = function (t, i, e, n) {
      ...
      for (n = n[0] / s * 2 * Math.PI, s = 0; o > s; s += 1) this.beginPath(),
        this.arc(t, i, e, s * a, s * a + n),
        this.stroke()
    }),
    L.zn = L.Class.extend({
      initialize: function (t) {
      ...
      AO: function (t, i) {
        i = i.split('&'),
          t.face = L.g.Ph(i[this.QD]),
          i[this.dv] ? (t.border = L.g.Ph(i[this.dv]), t.width = (this.S.sa ? 2 : 1) * (parseInt(i[this.LD]) || 1)) : t.border = null
      },
      DS: function () {
        var t = L.style.Bc
      ...
      mO: function (t, i, e, n, s, o) {
        return t = e - t,
          e = s - e,
          0 === t || 0 === e ? t === e ? !0 : !1 : (o - n) / e === (n - i) / t ? !0 : void 0
      },
      Qs: function (t, i, e, n) {
        var s, o = [],
          a = 0,
        ...
        if (e) {
          a = this.yb * i.x,
            ...
            i = i.L1,
            e = 0
          for (var h = t.length; h > e; e += 2) n = (a + t[e]) * i,
            s = (r + t[e + 1]) * i,
            o.push([n, s]),
            a += t[e],
            r += t[e + 1]
        } else for (i = (18 < i.hc ? Math.pow(2, 18 - i.hc) : 1) / (this.S.sa ? 2 : 1), e = 0, h = t.length; h > e; e += 2) {
          for (window.EK += 1; !n && 0 !== e && h - 2 > e && this.mO(t[e - 2], t[e - 1], t[e], t[e + 1], t[e + 2], t[e + 3]);) e += 2,
            window.$L += 1;
      ...
      $K: function (t, i, e) {
        var n = 0,
          s = 0,
          o = 1
        return e && (n = this.yb * i.x, s = this.yb * i.y, o = i.L1),
          [(n + t[0]) * o, (s + t[1]) * o]
      },
      Zs: function (t, i, e, n) {
      ...
      vu: function (t, i, e) {
        ...
        t.ta.hc = t.hc
        for (var o, a, r, h, l = 0,
               u = i.length; u > l; l += 1) if (s) {
          for (a = 0; a < i[l][0].length; a += 1) if (h = this.zj(t, i[l][0][a], i[l][1], e)) if (18 < t.hc) {
            var c = t.hc
            r = t.ta,
              o = Math.pow(2, c - 18)
          ...
          h = this.zj(t, i[l], a, e),
          o = this.Em ? i[l][this.Em] : 1,
          r = n[o] ? n[o] : n[o] = {},
        r[a] || (r[a] = [], 'road' === e.type ? (c = t.hc, o = 1, c > 18 && (o = Math.pow(2, c - 18)), this.BO(r[a], a, o)) : this.AO(r[a], a)),
          r[a].push(h)
        return n
      }
    }),
    L.aw = L.zn.extend({
      initialize: function () {
        L.zn.prototype.initialize.apply(this, arguments),
          this.fm = 0,
          this.Em = 2,
          this.Vm = 1,
          this.QD = 0,
    ...
    L.oq = L.zn.extend({
      ...
      zj: function (t, i, e) {
        if (t = this.Zs(i[this.fm], t.ta, e.Hc, 1), (i = i[4]) && i.length) {
          e = 0
          for (var n = i.length; n > e; e += 1) for (var s = i[e].split('-'), o = t[parseInt(s[0])], a = 1,
                                                       r = s.length; r > a; a += 1) o[parseInt(s[a])].mC = !0
        }
        return t
      },
      dK: function (t, i) {
        for (var e in i) if (i.hasOwnProperty(e)) {
          var n, s = i[e]
          for (n in s) if (s.hasOwnProperty(n)) for (var o = s[n], a = 0, r = o.length; r > a; a++) {
            var h = o[a]
    ...
    L.cw = L.zn.extend({
      ...
      BO: function (a, b, c) {
        ...
        c = b[2],
          c === d[1] ? q = 'round' : c === d[2] ? q = 'square' : 0 !== c.indexOf(d[5]) && (0 === c.indexOf(d[3]) ? l = eval('[' + c.substring(5).split(')') + ']') : 0 === c.indexOf(d[4]) && (g = m, m = 'white', l = eval('[' + c.substring(8).split(')') + ']'), h = n + 1 + (this.S.sa ? 1 : 0), n = n - 1 - (this.S.sa ? 1 : 0))),
        b[3] && (g = L.g.Ph(b[4]), h = parseInt(b[3]) * (this.S.sa ? 2 : 1) + n, b = b[5], b === d[1] ? k = 'round' : b === d[2] ? k = 'square' : 0 !== b.indexOf(d[5]) && 0 === b.indexOf(d[3]) && (f = eval('[' + b.substring(5).split(')') + ']'))),
          a.jD = m,
          a.xP = n,
          a.vP = q,
          a.wP = l,
      ...
      zj: function (t, i, e) {
        return e = this.Zs(i[this.fm], t.ta, e.Hc),
        (!t.S || i[this.Em] > t.S) && (t.S = i[this.Em], t.Rh = 0),
          t.Rh = Math.max(t.Rh, e.Rh),
          e
      }
    }),
    L.yn = L.zn.extend({
      initialize: function (t) {
        L.zn.prototype.initialize.apply(this, arguments),
          this.sd = [],
          this.WA = 'http://' + t.gE + '/icons/' + (L.h.Y || L.h.sa ? 'b' : 'n'),
          this.RK = L.h.Y ? 15 : 7,
          this.Yt = L.h.sa ? 320 : 256
      }
    }),
    L.pq = L.yn.extend({
      initialize: function () {
        L.yn.prototype.initialize.apply(this, arguments),
          this.cC = 0,
          this.RC = 1,
          this.eQ = 2,
          this.Vm = 1,
      ...
      zj: function (t, i, e, n) {
        ...
        return s && 5 < i.length && 1 === i[5] && (s.nH = !0),
          s
      }
    }),
    L.bw = L.yn.extend({
    ...
    L.P.canvas.pf = L.P.Eg.extend({
      ...
      EM: function (t) {
        ...
        var o = n - 1,
          ...
          r = t - 1,
          h = t + 1
        for (128 > s ? a = n : o = n, 128 > i ? h = t : r = t; a >= o; o += 1) for (var l = r; h >= l; l += 1) {
          var u = this.Ba.get(e + '/' + o + '/' + l)
          if (u && u.Ua) for (var c = u.Ua.length - 1; c >= 0; c -= 1) if (u.Ua[c].MC && u.Ua[c].rN && this.nN(u.Ua[c], s, i, o - n, l - t)) return u.Ua[c]
        }
        return null
      },
      ...
      reloadChanged: function () {
        this.K && (this.K.Ab = !1, L.jd.TA = null),
          this.Ba.clear(),
        this.Ca && this.Ca.parentNode && this.Ca.parentNode.removeChild(this.Ca),
        this.Ti && this.Ti.parentNode && this.Ti.parentNode.removeChild(this.Ti),
          this.set('display')
      },
      Hf: function () {
    ...
    L.P.canvas.pf.include({
      GF: function (t) {
        this.fe = {},
          this.webSocket = new L.WebSocket,
          this.webSocket.e('tiles', this.gO, this),
          this.webSocket.e('ack', this.fO, this),
          this.webSocket.e('disable', this.dO, this),
          this.J('mapStyle', t, !0)
      },
      Ew: function () {
      ...
      gO: function (t) {
        ...
        if (i === this.xb) {
          t = t.content.data
          for (var e = 0,
                 n = t.length; n > e; e += 1) this.nC(t[e], i)
        ...
        if (t.length) {
          ...
          for (var s = this.K.aj.If(t[0].ta.z), o = 0; o < t.length; o += 1) {
            ...
            if (a.hc = i, r.L1 = s, i > 18) {
              ...
              c && (c = u + '/' + h + '/' + l, (d = this.Ba.get(c)) ? (a.status = d.status, a.X = d.X, a.gg = d.gg) : (d = new L.of(new L.nf(u, h, l)), this.Ba.set(c, d), d.status = 'loading'), d.pb = a, a.pb = d)
            }
      ...
      wl: function (t, i, e) {
        ...
        for (var n = 0; n < t.length; n += 1) {
          var s = t[n]
          this.tD(i, s, e, L.g.bind(this.uC, this)),
          i > 18 && this.Ba.cl(s.key + '/' + i)
        }
      },
      TB: function (t, i, e) {
        function n (t) {
        ...
        this.bN || (this.bN = 1, L.jd.TA = s.startTime = new Date),
          s.open('GET', e, !0),
          s.send()
      },
      XD: function (t, i) {
    ...
    L.P.canvas.pf.include({
      Zd: function () {
        this.Ca = document.createElement('div'),
          this.Ti = document.createElement('canvas'),
          this.La = new L.P.canvas.pf.Buildings(this.Ti, this.On),
          this.Xo = document.createDocumentFragment()
      },
      YO: function (t) {
      ...
      XO: function (t, i) {
        ...
        if (e >= 8) this.cD(t, i)
          ...
          this.transform[0] = {
            ...
            e = this.Rc,
            this.Bp(t, 256 * e.Nm, 256 * e.vp),
            e = new L.Pixel(t.Ea.mb.x * (this.K.sa ? this.K.hf : 1), t.Ea.mb.y * (this.K.sa ? this.K.hf : 1)),
            this.transform[2] = {
              translate: e,
      ...
      cD: function (t, i) {
        (!this.ba || 3e4 < Math.abs(this.fb.x - this.ba.x) / this.L1 || 3e4 < Math.abs(this.fb.y - this.ba.y) / this.L1) && (this.ba = this.fb),
          this.Jd = this.xb,
          this.xg = this.nb,
          this.Iu = !1,
          ...
          this.wQ = i.wQ
        var e = this.Rc
        this.Eb = [256 * e.te * this.nb, 256 * e.gd * this.nb],
          this.Sf = i.Bo
        var n = this.jv,
          s = 256 * e.Nm,
          e = 256 * e.vp
        ...
        o.x < -L.g.Wa / 2 && (o.x += L.g.Wa),
        o.x > L.g.Wa / 2 && (o.x -= L.g.Wa),
          this.dL = o.divideBy(this.nb),
          this.nP(n, s, e, i),
          this.Bp(t, s, e),
          this.VN = !1,
        this.Iu && this.set('display', 0),
          this.Jc(t)
      },
      yd: function (t, i) {
        this.Du(t, i),
          this.gp && (t.kv || t.Up && L.h.Sd || t.iu && t.SK) ? this.YO(t, i) : this.gp && t.lf ? this.XO(t, i) : this.cD(t, i),
          this.gp = this.fb
      },
      Dj: function () {
        for (var t = Array.prototype.slice.call(this.Ca.childNodes, 0),
               i = t.length - 1; i >= 0; i -= 1) t[i] && t[i].Pb !== this.Pb && this.Ca.removeChild(t[i])
      },
      nP: function (t) {
        var i = this.Pb
        this.Pb += 1
        var e, n, s, o = !1,
          a = !1,
          r = []
        for (this.ba.x - this.fb.x < -L.g.Wa / 2 ? this.ba = new L.Pixel(this.ba.x + L.g.Wa, this.ba.y) : this.ba.x - this.fb.x > L.g.Wa / 2 && (this.ba = new L.Pixel(this.ba.x - L.g.Wa, this.ba.y)), e = t.length - 1; e >= 0; e -= 1) if (s = t[e], n = s.hc, s.length) {
          var a = !1,
            h = n - this.xb;
          ...
          for (var l = this.Tm(this.xb, n), u = s.length - 1; u >= 0; u -= 1) {
            ...
            d.x < -L.g.Wa / 2 ? c.x += L.g.Wa : d.x > L.g.Wa / 2 && (c.x -= L.g.Wa),
              d = c.subtract(this.ba),
              d = d.divideBy(this.nb),
              d.x = Math.floor(d.x),
              d.y = Math.floor(d.y),
            (!h.Ln || this.qw && h.Pb !== i) && (h.Ln = this.currentTime),
              h.Jl = !1,
              h.X ? (h.Pb = this.Pb, c = h.Dc, !c && h.pb && h.pb.Dc && (c = h.pb.Dc), c && (h.ol = 1, this.zt(c, d.x, d.y, l, l, 1, n.z), c.parentNode !== this.Ca && this.Ca.appendChild(c), c.Pb = this.Pb, h.xb = this.xb, r.push(h))) : h.Uc = null
          }
          a = !0
        }
        return this.Hg = r,
      ...
      Bp: function (t) {
        ...
        e.lf = this.lf
        var n = this.K.sa ? this.K.hf : 1
        if (0 !== t.va.rotation ? L.d.Rm(i, 2 * Math.floor(t.Ea.mb.x) * n, 2 * Math.floor(t.Ea.mb.y) * n, !0) : L.d.Rm(i, t.size.width * n, t.size.height * n, !0), e.Eb = [t.Ea.kb.x, t.Ea.kb.y], this.La.nb = this.L1 * (this.K.sa ? 1 / this.K.hf : 1), (i = this.Hg.ak) && i.length && !(.5 < i[0].ta.z - this.zoom)) for (e = i.length - 1; e >= 0; e -= 1) {
          var n = i[e].Ua,
            s = !1
          !n && i[e].pb && i[e].pb.Ua && (n = i[e].pb.Ua, s = !0),
            this.La.Bp(n || {},
              s, t.lf || i[0].ta.z !== this.zoom, L.Qe && L.Qe.FB(this.w.Fb))
        }
      },
      Jc: function (t) {
        var i = Math.pow(2, this.zoom - this.xb),
          e = this.fb.subtract(this.ba)
        e.x < -L.g.Wa / 2 && (e.x += L.g.Wa),
        e.x > L.g.Wa / 2 && (e.x -= L.g.Wa),
          e.divideBy(this.nb),
          t = new L.Pixel(t.Ea.mb.x * (this.K.sa ? this.K.hf : 1), t.Ea.mb.y * (this.K.sa ? this.K.hf : 1)),
          this.transform = [{
            translate: this.dL,
            scale: i,
            rotate: 0
    ...
    L.P.canvas.pf.Buildings = L.Class.extend({
      ...
      Ku: function (t, i, e, n, s) {
        var o, a, r, h, l, u, c, d = this.tb.getContext('2d'),
          p = [NaN, NaN, 0],
          f = [NaN, NaN]
        for (d.save(), e && n && (d.strokeStyle = e, d.lineWidth = n), i && (d.fillStyle = i), this.fl = {},
               d.beginPath(), o = 0, a = t.length; a > o; o += 1) if (r = t[o], h = r.length, h > 0) for (var m = 0; h > m; m += 1) for (l = r[m], u = 0, c = l.length; c > u; u += 1) p = l[u],
          0 === u ? (f = p, d.moveTo(p[0], p[1])) : (p[0] !== f[0] || p[1] !== f[1]) && (d.lineTo(p[0], p[1]), f = p)
        if (i && d.fill(), s) for (d.beginPath(), o = 0, a = t.length; a > o; o += 1) if (r = t[o], h = r.length, h > 0) for (m = 0; h > m; m += 1) for (l = r[m], u = 0, c = l.length; c > u; u += 1) p = l[u],
          0 === u ? (f = p, d.moveTo(p[0], p[1])) : (p[0] !== f[0] || p[1] !== f[1]) && (f.mC ? (d.moveTo(p[0], p[1]), p.mC && d.lineTo(p[0], p[1])) : d.lineTo(p[0], p[1]), f = p)
        return e && n && d.stroke(),
          d.restore(),
          !0
      },
      Zo: function (t) {
        ...
        var i = this.sd[t]
        return 'undefined' == typeof i ? (i = document.createElement('img'), i.src = t, this.sd[t] = i, i.loaded = !1, L.l.mh(i, 'load', this.Mt, this), null) : i.loaded ? i : void 0
      },
      Mt: function (t) {
        t.target.loaded = !0,
        this.Jg && this.Jg()
      ...
      eD: function (t, i, e, n, s) {
        ...
        return o.save(),
          ...
          o.lineCap = n,
          o.lineJoin = 'bevel',
          o.setLineDash ? (this.Tz(o, t), s && (o.setLineDash(s), o.lineDashOffset = s[0])) : s && 1 < s.length ? this.XK(o, t, s) : this.Tz(o, t),
          o.stroke(),
          o.restore(),
          !0
      },
      Tz: function (t, i) {
        ...
        for (e = 0, a = i.length; a > e; e += 1) for (r = i[e], n = 0, h = r.length; h > n; n += 1) for (u = r[n], s = 0, l = u.length; l > s; s += 1) o = u[s],
          0 === s ? (t.moveTo(o[0], o[1]), c = o) : (o[0] !== c[0] || o[1] !== c[1]) && (t.lineTo(o[0], o[1]), c = o)
      },
      XK: function (t, i, e) {
        t.beginPath()
        var n, s, o, a, r, h, l, u, c, d
        for (n = 0, r = i.length; r > n; n += 1) for (h = i[n], t.Oo = e[0] + e[1], t.Um = !1, s = 0, l = h.length; l > s; s += 1) for (c = h[s], o = 0, u = c.length; u > o; o += 1) a = c[o],
          0 === o ? (t.moveTo(a[0], a[1]), d = a) : (a[0] !== d[0] || a[1] !== d[1]) && (t.at(d[0], d[1], a[0], a[1], e), d = a);
        t.closePath()
      }
    }),
    L.P.canvas.pf.Buildings.include({
      Bp: function (t, i, e, n) {
        for (var s = 0,
               o = t.length; o > s; s += 1) if (!(e && t[s].uN || n && t[s].nH)) {
          var a = t[s].Ta,
            r = a[0]
          i && (r > I.g.Wa / 2 ? r -= I.g.Wa : r < I.g.Wa / 2 && (r += I.g.Wa))
          for (var a = this.Gb(r, a[1]), r = 0,
                 h = t[s].sd.length; h > r; r += 1) this.dP(a, t[s].sd[r], t[s].vg[r], t[s].Ou, t[s]._sd || t[s].__sd)
        }
      },
        ...
        if (this.__isExtract) {
          if (i && i.indexOf && i.indexOf('png') > -1) {
            ...
            s ? r.__loadedImg__[i] ? (r._dP(t, r.__loadedImg__[i].cloneNode(), e, n, o), r._dP(t, s[i][0], s[i][1], n, o)) : (a = document.createElement('img'), a.src = i, a.onload = function () {
              r._dP(t, a, e, n, o),
                r._dP(t, s[i][0], s[i][1], n, o),
                r.__loadedImg__[i] = a.cloneNode(),
                a.onload = null
      ...
      _dP: function (t, i, e, n, s) {
        ...
        4 === e.length ? s.drawImage(i, t[0] + r, t[1] + h, o, a) : s.drawImage(i, e[4], e[5], e[6], e[7], t[0] + r, t[1] + h, o, a),
        0 !== n && s.setTransform(1, 0, 0, 1, 0, 0)
      },
      _Zo: function (t) {
        if ('IMG' === t.tagName || 'CANVAS' === t.tagName) return t
        var i = this.sd[t]
    ...
    L.yn.include({
      zj: function (t, i, e, n) {
        ...
        if (!(255 < d[0] || 0 > d[0] || 255 < d[1] || 0 > d[1])) {
          ...
          p.wd = d,
            p.sd = [],
            p.vg = [],
          e[this.cv] && (r = L.g.Ph(e[this.cv]))
          var f, m
          if ('roadlabel' === n.type) n = !1,
            p.uN = !0,
          (e = e[this.Of]) && i[this.ym] && (p.sd.push(this.WA + (10 > t.ta.z ? '39' : '18') + '/1/' + e + '.png'), u = '152' === e ? 'black' : 'white', r = null, c = i[this.ym], s && (c[0] *= o, c[1] *= o, c[2] *= o, c[3] *= o), p.vg.push(c), c = 400, h = 'Arial Narrow,Arial', n = !0),
          n && (L.h.Y ? (f = 47, m = 15) : (f = 22, m = 13), s && (f *= o, m *= o)),
            l = Math.round(l),
            c = this.hB(t, a.replace(' ', ''), h, l, u, r, c, f),
            p.sd.push(c),
            1 < a.length || n ? (t = Math.ceil(c.gi / 2), s = c.gi, f && (s = Math.min(f, s), t = Math.min(Math.floor(f / 2) - 1, t)), c.pm === l && (m = l), p.vg.push([-t, -Math.ceil(m / 2), s, c.pm, c.ru, c.su, c.gi, c.pm])) : (l = c.pm + 2, t = -c.pm / 2, p.vg.push([-c.gi / 2, t, l, l, c.ru, c.su, c.fn, c.wm])),
            p.Ou = i[this.Gs] ? 5 > i[this.Gs] ? 0 : i[this.Gs] : 0,
          1 < a.length && p.sd[0].indexOf && p.sd[0].indexOf('png') > -1 && (p._sd = {},
            p._sd[p.sd[0]] = [c, p.vg[p.vg.length - 1]])
          else {
            if (p.name = a.replace('^', ''), a = a.split('^'), m = i[this.eQ], e[this.Of] && i[this.ym] && (p.rN = !0, p.sd.push(this.WA + (10 > t.ta.z ? '39' : '18') + '/1/' + e[this.Of] + '.png'), c = i[this.ym], '334' === e[this.Of] && s && (c[0] = c[1] = -7, c[3] = c[2] = 15), '445' === e[this.Of] && s && (c[0] = -3, c[1] = -6, c[3] = 13, c[2] = 6), '301' === e[this.Of] && s && (c[1] = c[0], c[3] = c[2]), s && (c[0] *= o, c[1] *= o, c[2] *= o, c[3] *= o), p.vg.push(c)), 0 < m.length) for (n = 0; n < m.length; n += 1) {
              var c = _n = a[n],
                d = m[n][0],
                _ = m[n][1] + n;
              ('375' === e[this.Of] || '3751' === e[this.Of]) && (l = 12, _ = -5, f = 15, s && (l *= o, f *= o)),
                l = Math.round(l),
                c = this.hB(t, c, h, l, u, r, null, f, e[this.OD]),
              s && (d *= o, _ *= o, m[n][2] *= o, m[n][3] *= o),
              ('375' === e[this.Of] || '3751' === e[this.Of]) && (d = -Math.min(c.gi / 2, f / 2)),
                p.sd.push(c),
                _ -= L.h.Y ? 3 : 1,
                p.vg.push([d, _, e[this.OD] ? c.gi : Math.min(m[n][2], c.gi), c.wm, c.ru, c.su, c.gi, c.wm])
            }
            1 == m.length && p.sd[0].indexOf && p.sd[0].indexOf('png') > -1 && (p.__sd = {},
              p.__sd[p.sd[0]] = [c, p.vg[p.vg.length - 1]]),
            i[4] && (p.MC = i[4])
          }
          return p
        }
      ...
      hB: function (t, i, e, n, s, o, a, r, h) {
        ...
        var u = l.he
        a = a || this.$M(n),
          t = this.S.sa ? this.S.VD : 1
        var c = h ? 2 * t : 0,
          d = (n + 2) * i.length + 2,
          p = n + 5 * t,
          f = l.DC,
          m = l.EC
        return f + d > this.Yt && (f = 0, m += l.maxHeight, m > this.Yt && (l.maxHeight = 0)),
          l.maxHeight = Math.max(l.maxHeight || 0, p),
          u.font = a + ' ' + n + 'px ' + e,
          n = parseInt(u.font),
        (n > 100 || !n) && (n = parseInt(u.font.split(' ')[1])),
          e = n * i.length,
        o && (u.strokeStyle !== o && (u.strokeStyle = o), u.strokeText(i, f + c, m + n, r || e)),
          o = u.measureText(i).width,
        h && (h = L.g.Ph(h), u.fillStyle !== h && (u.fillStyle = h), u.fillRect(f, m, o + 4 * t, n + 4 * t + L.h.Y)),
        u.fillStyle !== s && (u.fillStyle = s),
          u.fillText(i, f + c, m + n, r || e),
          l.DC = f + d,
          l.EC = m,
          i = l,
          i.gi = h ? o + 4 * t : o,
    ...
    L.TileLayer.WMS = L.TileLayer.extend({
      ...
      initialize: function (t, i) {
        ...
        i = L.setOptions(this, i),
          e.width = e.height = i.tileSize * (i.detectRetina && L.Browser.retina ? 2 : 1),
          this.wmsParams = e
      },
      onAdd: function (t) {
      ...
      setParams: function (t, i) {
        return L.extend(this.wmsParams, t),
        i || this.redraw(),
          this
      }
    }),
    ...
    L.ImageOverlay = L.Layer.extend({
      ...
      initialize: function (t, i, e) {
        this._url = t,
          this._bounds = L.latLngBounds(i),
          L.setOptions(this, e)
      },
      onAdd: function () {
        this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
        this.options.interactive && (L.DomUtil.addClass(this._image, 'imap-interactive'), this.addInteractiveTarget(this._image)),
      ...
      bringToFront: function () {
        return this._map && L.DomUtil.toFront(this._image),
          this
      },
      bringToBack: function () {
        return this._map && L.DomUtil.toBack(this._image),
          this
      },
      setUrl: function (t) {
        return this._url = t,
      ...
      _initImage: function () {
        ...
        t.onselectstart = L.Util.falseFn,
          t.onmousemove = L.Util.falseFn,
          t.onload = L.bind(this.fire, this, 'load'),
    ...
    L.Icon = L.Class.extend({
      ...
      _setIconStyles: function (t, i) {
        ...
        t.className = 'imap-marker-' + i + ' ' + (e.className || ''),
        o && (t.style.marginLeft = -o.x + s.x + 'px', t.style.marginTop = -o.y + s.y + 'px'),
        n && (t.style.width = n.x + 'px', t.style.height = n.y + 'px'),
        t.src && (t.style.background = 'url(' + t.src + ') no-repeat  ' + r.x + 'px  ' + r.y + 'px'),
          t.style.visibility = a
      },
    ...
    L.Icon.Default.imagePath = function () {
      var t, i, e, n, s = document.getElementsByTagName('script'),
        o = /[\/^]imap[\-\._]?([\w\-\._]*)\.js\??/
      for (t = 0, i = s.length; i > t; t++) if (e = s[t].src || '', e.match(o)) return n = e.split(o)[0],
      (n ? n + '/' : '') + 'images'
    }(),
    L.Marker = L.Layer.extend({
      ...
      _initIcon: function () {
        var t = this.options,
          ...
          e = !1
        i !== this._icon && (this._icon && this._removeIcon(), e = !0, t.title && (i.title = t.title), t.alt && (i.alt = t.alt)),
      ...
      _removeShadow: function () {
        this._shadow && L.DomUtil.remove(this._shadow),
          this._shadow = null
      },
      _setPos: function (t) {
        L.DomUtil.setPosition(this._icon, t, this.options.rotate),
        this._shadow && L.DomUtil.setPosition(this._shadow, t),
      ...
      _updateOpacity: function () {
        ...
        L.DomUtil.setOpacity(this._icon, t),
        this._shadow && L.DomUtil.setOpacity(this._shadow, t)
      },
    ...
    L.VectorIcon.MAP_POINT_PIN = 'M16,1 C7.7146,1 1,7.65636364 1,15.8648485 C1,24.0760606 16,51 16,51 C16,51 31,24.0760606 31,15.8648485 C31,7.65636364 24.2815,1 16,1 L16,1 Z',
    L.VectorIcon.Icon = L.Icon.extend({
      ...
      createIcon: function (t) {
        var i, e, n, s, o, a = ''
        i = t && 'DIV' === t.tagName ? t : document.createElement('div'),
          e = this.options,
        e.icon && (a = this._createInner()),
          s = 'filter:alpha(opacity=' + 10 * e.alpha + ');opacity:' + e.alpha,
          n = L.VectorIcon.MAP_POINT_PIN
        var r = 26,
          h = 26
        return 1 == e.type ? (r = 32, h = 52, o = '<path d="' + n + '" fill="' + e.markerColor + '" stroke="' + e.strokecolor + '" stroke-width="' + e.strokewidth + '" style="' + s + '"></path>') : 2 == e.type ? o = '<rect x="4" y="4" width="18" height="18" fill="' + e.markerColor + '" stroke="' + e.strokecolor + '" stroke-width="' + e.strokewidth + '" style="' + s + '"></rect>' : 3 == e.type && (o = '<circle cx="13" cy="13" r="10" fill="' + e.markerColor + '" stroke="' + e.strokecolor + '" stroke-width="' + e.strokewidth + '" style="' + s + '"></circle>'),
          i.innerHTML = '<svg width="' + e.iconSize[0] + 'px" height="' + e.iconSize[1] + 'px" viewBox="0 0 ' + r + ' ' + h + '" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">' + o + a + '</svg>',
      ...
      _createInner: function () {
        ...
        return t = void 0,
          ...
          e = '',
          s = this.options,
          t = '' === s.prefix || s.icon.slice(0, s.prefix.length + 1) === s.prefix + '-' ? s.icon : s.prefix + '-' + s.icon,
        s.spin && 'string' == typeof s.spinClass && (n = s.spinClass),
        s.iconColor && ('white' === s.iconColor || 'black' === s.iconColor ? i = 'icon-' + s.iconColor : e = 'style=\'color: ' + s.iconColor + '\' '),
        '<i ' + e + 'class=\'' + s.extraClasses + ' ' + s.prefix + ' ' + t + ' ' + n + ' ' + i + '\'></i>'
      },
      _setIconStyles: function (t, i) {
        var e, n, s, o
        return n = this.options,
          s = L.point(n['shadow' === i ? 'shadowSize' : 'iconSize']),
          e = void 0,
          o = L.point(n.offset),
          e = L.point(n.anchor),
        !e && s && (e = s.divideBy(2, !0)),
        'shadow' === i && (e.x -= 5),
          t.className = 'vector-marker-' + i + ' ' + n.className,
    ...
    L.DivIcon = L.Icon.extend({
      ...
      createIcon: function (t) {
        var i = t && 'DIV' === t.tagName ? t : document.createElement('div'),
          e = this.options
        return i.innerHTML = e.html !== !1 ? e.html : '',
        e.bgPos && (i.style.backgroundPosition = -e.bgPos.x + 'px ' + -e.bgPos.y + 'px'),
          this._setIconStyles(i, 'icon'),
          i
      },
      createShadow: function () {
    ...
    L.Handler.MarkerDrag = L.Handler.extend({
      ...
      addHooks: function () {
        ...
        this._draggable || (this._draggable = new L.Draggable(t, t, !0)),
          this._draggable.on({
            ...
            this).enable(),
          L.DomUtil.addClass(t, 'imap-marker-draggable')
      },
      removeHooks: function () {
        this._draggable.off({
            dragstart: this._onDragStart,
          ...
          this).disable(),
        this._marker._icon && L.DomUtil.removeClass(this._marker._icon, 'imap-marker-draggable')
      },
      moved: function () {
        return this._draggable && this._draggable._moved
      },
      _onDragStart: function () {
        ...
        if (t.raiseOnDrag && !e._ischangeOffset) {
          ...
          h.style.cssText = 'position:absolute;background:url(' + t.raiseUrl + ') ;width:11px;height:11px;overflow: hidden;margin-top:' + r + 'px;margin-left:' + a + 'px',
            h.style.transform = i.style.transform,
            e._bottomEle = h,
            i.parentNode.appendChild(h),
            i.style.marginTop = parseInt(i.style.marginTop) - 25 + 'px'
        }
      },
      _onDrag: function (t) {
        var i = this._marker,
    ...
    L.Popup = L.Layer.extend({
      ...
      initialize: function (t, i) {
        if (L.setOptions(this, t), this._source = i, 0 == t.type) {
          this._anchorOffset = [-.5, -1],
            this._popupContent = L.DomUtil.create('div', 'imap-window'),
            this._popupContent.style.width = t.width + 4 + 'px'
          var e = L.DomUtil.create('div', 'imap-window-title')
          e.style.width = t.width - 6 + 'px',
            e.innerHTML = t.title
          var n = L.DomUtil.create('div', 'imap-window-content')
          n.style.width = t.width - 6 + 'px',
            n.style.height = t.height - 69 + 'px',
            this._popupContent.appendChild(e),
            this._popupContent.appendChild(n)
        } else this._anchorOffset = [0, 0],
          this._popupContent = L.DomUtil.create('div', 'imap-zoom-animated'),
          this._popupContent.style.position = 'absolute',
          L.DomEvent.disableClickPropagation(this._popupContent).disableScrollPropagation(this._popupContent).on(this._popupContent, 'contextmenu', L.DomEvent.stopPropagation)
      },
      onAdd: function (t) {
        this._zoomAnimated = this._zoomAnimated && this.options.zoomAnimation,
        this._container || this._initLayout(),
        t._fadeAnimated && !this.options.type && L.DomUtil.setOpacity(this._container, 0),
          clearTimeout(this._removeTimeout),
          'string' == typeof this._container ? this.getPane().innerHTML = this._container : this.getPane().appendChild(this._container),
          this.update(),
        t._fadeAnimated && !this.options.type && L.DomUtil.setOpacity(this._container, 1),
          t.fire('popupopen', {
            popup: this
          }),
      ...
      onRemove: function (t, i) {
        t && t._fadeAnimated ? (L.DomUtil.setOpacity(this._container, 0), this._removeTimeout = setTimeout(L.bind(L.DomUtil.remove, L.DomUtil, this._container), 200)) : L.DomUtil.remove(this._container),
        i && this.fire('removetip', {
          type: 'removetip'
        }),
        t && t.fire('popupclose', {
          popup: this
      ...
      setTitle: function (t) {
        this.options.type || (this._popupContent.childNodes[0].innerHTML = t),
          this._content = this._popupContent,
          this.update()
      },
      getContent: function () {
      ...
      setContent: function (t) {
        return this.options.type ? (this._popupContent.innerHTML = t, this._container = this._popupContent) : this._popupContent.childNodes[1].innerHTML = t,
          this._content = this._popupContent,
          this.update(),
          this
      },
      setSize: function (t, i) {
        this.options.width = t,
          ...
          this.options.type ? (this._popupContent.childNodes[0].style.width = t + 'px', this._popupContent.childNodes[0].style.height = i + 'px') : (this._popupContent.style.width = t + 4 + 'px', this._popupContent.childNodes[0].style.width = t - 6 + 'px', this._popupContent.childNodes[1].style.width = t - 6 + 'px', this._popupContent.childNodes[1].style.height = i - 69 + 'px')
      },
      getElement: function () {
        return this._container
      },
      update: function (t) {
        t instanceof Array && (this.options.autoPanPaddingTopLeft = [t[0].x, t[0].y], this.options.autoPanPaddingBottomRight = [t[1].x, t[1].y]),
        this._map && (this._container.style.visibility = 'hidden', this.options.type || (this._updateContent(), this._updateLayout()), this._updatePosition(), this._container.style.visibility = '', this._adjustPan())
      },
      getEvents: function () {
        var t = {
      ...
      bringToFront: function () {
        return this._map && L.DomUtil.toFront(this._container),
          this
      },
      bringToBack: function () {
        return this._map && L.DomUtil.toBack(this._container),
          this
      },
      _close: function () {
      ...
      _initLayout: function () {
        ...
        if (this.options.closeButton) {
          ...
          e.href = '#close',
            e.innerHTML = '&#215;',
            L.DomEvent.on(e, 'click', this._onCloseButtonClick, this)
        }
        var n = this._wrapper = L.DomUtil.create('div', t + '-content-wrapper', i)
        this._contentNode = L.DomUtil.create('div', t + '-content', n),
          L.DomEvent.disableClickPropagation(n).disableScrollPropagation(this._contentNode).on(n, 'contextmenu', L.DomEvent.stopPropagation),
          this._tipContainer = L.DomUtil.create('div', t + '-tip-container', i),
          this._tip = L.DomUtil.create('div', t + '-tip', this._tipContainer)
      },
      ...
      _updateLayout: function () {
        ...
        e || (e = Math.min(e, this.options.maxWidth), e = Math.max(e, this.options.minWidth)),
          i.width = e + 1 + 'px',
          this.options.width = e
        var n = t.offsetHeight || this.options.height
        n || (n = Math.min(n, this.options.maxHeight), n = Math.max(n, this.options.minHeight)),
          i.height = n + 1 + 'px',
      ...
      _updatePosition: function () {
        if (this._map) {
          ...
          t = t.subtract([this.options.width * (e[0] + this._anchorOffset[0]), this.options.height * (e[1] + this._anchorOffset[1])]),
            this._zoomAnimated ? L.DomUtil.setPosition(this._container, t) : i = i.add(t)
      ...
      _adjustPan: function () {
        if (!(!this.options.autoPan || this._map._panAnim && this._map._panAnim._inProgress)) {
          ...
          var s = t.layerPointToContainerPoint(n),
            ...
            l = 0,
            u = 0
          s.x + e + r.x > h.x && (l = s.x + e - h.x + r.x),
          s.x - l - a.x < 0 && (l = s.x - a.x),
          s.y + i + r.y > h.y && (u = s.y + i - h.y + r.y),
          s.y - u - a.y < 0 && (u = s.y - a.y),
    ...
    L.Map.include({
      openPopup: function (t, i, e) {
        return t instanceof L.Popup || (t = new L.Popup(e).setContent(t)),
        i && t.setLatLng(i),
          this.hasLayer(t) ? this : (this._popup && this._popup.options.autoClose && (L.stamp(this._popup) != L.stamp(t) && this._popup.fire('tipclose', {
            type: 'tipclose'
    ...
    L.Layer.include({
      bindPopup: function (t, i) {
        return t instanceof L.Popup ? (L.setOptions(t, i), this._popup = t, t._source = this) : ((!this._popup || i) && (this._popup = new L.Popup(i, this)), this._popup.setContent(t)),
      ...
      openPopup: function (t, i) {
        if (t instanceof L.Layer || (i = t, t = this), t instanceof L.FeatureGroup) for (var e in this._layers) {
          t = this._layers[e]
          break
        }
        return i || (i = t.getCenter ? t.getCenter() : t.getLatLng()),
        this._popup && this._map && (this._popup.options.offset = this._popupAnchor(t), this._popup._source = t, this._popup.update(), this._map.openPopup(this._popup, i)),
          this
      },
      closePopup: function () {
    ...
    L.Renderer = L.Layer.extend({
      ...
      onAdd: function () {
        this._container || (this._initContainer(), this._zoomAnimated && L.DomUtil.addClass(this._container, 'imap-zoom-animated')),
      ...
      _update: function () {
        ...
        this._bounds = new L.Bounds(e, e.add(i.multiplyBy(1 + 2 * t)).round()),
    ...
    L.LineUtil = {
      simplify: function (t, i) {
        ...
        var e = i * i
        return t = this._reducePoints(t, e),
      ...
      _simplifyDP: function (t, i) {
        var e = t.length,
          ...
          s = new n(e)
        s[0] = s[e - 1] = 1,
          this._simplifyDPStep(t, s, i, 0, e - 1)
        var o, a = []
      ...
      _reducePoints: function (t, i) {
        for (var e = [t[0]], n = 1, s = 0,
               o = t.length; o > n; n++) this._sqDist(t[n], t[s]) > i && (e.push(t[n]), s = n);
        return o - 1 > s && e.push(t[o - 1]),
          e
      },
      clipSegment: function (t, i, e, n, s) {
        ...
        for (this._lastCode = l; ;) {
          ...
          if (h & l) return !1
          o = h || l,
            a = this._getEdgeIntersection(t, i, o, e, s),
            r = this._getBitCode(a, e),
            o === h ? (t = a, h = r) : (i = a, l = r)
        }
      },
      _getEdgeIntersection: function (t, i, e, n, s) {
        var o, a, r = i.x - t.x,
          ...
          l = n.min,
          u = n.max
        return 8 & e ? (o = t.x + r * (u.y - t.y) / h, a = u.y) : 4 & e ? (o = t.x + r * (l.y - t.y) / h, a = l.y) : 2 & e ? (o = u.x, a = t.y + h * (u.x - t.x) / r) : 1 & e && (o = l.x, a = t.y + h * (l.x - t.x) / r),
          new L.Point(o, a, s)
      },
      ...
      _sqClosestPointOnSegment: function (t, i, e, n) {
        var s, o = i.x,
          ...
          h = e.y - a,
          l = r * r + h * h
        return l > 0 && (s = ((t.x - o) * r + (t.y - a) * h) / l, s > 1 ? (o = e.x, a = e.y) : s > 0 && (o += r * s, a += h * s)),
          r = t.x - o,
          h = t.y - a,
          n ? r * r + h * h : new L.Point(o, a)
      }
    },
    L.Polyline = L.Path.extend({
      ...
      spliceLatLngs: function () {
        ...
        return this._convertLatLngs(t, !0),
          this.redraw(),
          i
      },
      isEmpty: function () {
      ...
      closestLayerPoint: function (t) {
        for (var i, e, n = 1 / 0,
               s = null,
               o = L.LineUtil._sqClosestPointOnSegment,
               a = 0,
               r = this._parts.length; r > a; a++) for (var h = this._parts[a], l = 1, u = h.length; u > l; l++) {
          i = h[l - 1],
            e = h[l]
          var c = o(t, i, e, !0)
          n > c && (n = c, s = o(t, i, e))
      ...
      getCenter: function () {
        ...
        for (t = 0, n = 0; h - 1 > t; t++) if (s = r[t], o = r[t + 1], e = s.distanceTo(o), n += e, n > i) return a = (n - i) / e,
          this._map.layerPointToLatLng([o.x - a * (o.x - s.x), o.y - a * (o.y - s.y)])
      },
      getBounds: function () {
        return this._bounds
      },
      ...
      _convertLatLngs: function (t) {
        for (var i = [], e = L.Polyline._flat(t), n = 0,
               s = t.length; s > n; n++) e ? (i[n] = L.latLng(t[n]), this._bounds.extend(i[n])) : i[n] = this._convertLatLngs(t[n]);
        return i
      },
      _project: function () {
        this._rings = [],
      ...
      _clipPoints: function () {
        ...
        if (this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
          ...
          for (i = 0, n = 0, s = this._rings.length; s > i; i++) for (r = this._rings[i], e = 0, o = r.length; o - 1 > e; e++) a = L.LineUtil.clipSegment(r[e], r[e + 1], t, e, !0),
          a && (h[n] = h[n] || [], h[n].push(a[0]), (a[1] !== r[e + 1] || e === o - 2) && (h[n].push(a[1]), n++))
        }
      },
      _simplifyPoints: function () {
        for (var t = this._parts,
               ...
               e = 0,
               n = t.length; n > e; e++) t[e] = L.LineUtil.simplify(t[e], i)
      },
      _update: function () {
    ...
    L.Sector = L.Path.extend({
      ...
      initialize: function (t, i, e, n) {
        ...
        L.setOptions(s, n),
          s._position = t,
          s._radius = i,
          s._degree = isNaN(e) ? 90 : Math.max(0, Math.min(parseInt(e), 360))
      },
      getBounds: function () {
        return this._bounds
      },
    ...
    L.PolyUtil = {},
    L.PolyUtil.clipPolygon = function (t, i, e) {
      var n, s, o, a, r, h, l, u, c, d = [1, 4, 2, 8],
        p = L.LineUtil
      for (s = 0, l = t.length; l > s; s++) t[s]._code = p._getBitCode(t[s], i);
      for (a = 0; 4 > a; a++) {
        for (u = d[a], n = [], s = 0, l = t.length, o = l - 1; l > s; o = s++) r = t[s],
          h = t[o],
          r._code & u ? h._code & u || (c = p._getEdgeIntersection(h, r, u, i, e), c._code = p._getBitCode(c, i), n.push(c)) : (h._code & u && (c = p._getEdgeIntersection(h, r, u, i, e), c._code = p._getBitCode(c, i), n.push(c)), n.push(r));
        t = n
      }
      return t
    },
    L.Polygon = L.Polyline.extend({
      ...
      getCenter: function () {
        var t, i, e, n, s, o, a, r, h, l = this._rings[0],
          u = l.length
        if (!u) return null
        for (o = a = r = 0, t = 0, i = u - 1; u > t; i = t++) e = l[t],
          n = l[i],
          s = e.y * n.x - n.y * e.x,
          a += (e.x + n.x) * s,
          r += (e.y + n.y) * s,
          o += 3 * s;
        return h = 0 === o ? l[0] : [a / o, r / o],
          this._map.layerPointToLatLng(h)
      },
      _convertLatLngs: function (t) {
        var i = L.Polyline.prototype._convertLatLngs.call(this, t),
          e = i.length
        return e >= 2 && i[0] instanceof L.LatLng && i[0].equals(i[e - 1]) && i.pop(),
          i
      },
      _setLatLngs: function (t) {
        L.Polyline.prototype._setLatLngs.call(this, t),
        L.Polyline._flat(this._latlngs) && (this._latlngs = [this._latlngs])
      },
      _defaultShape: function () {
      ...
      _clipPoints: function () {
        ...
        if (t = new L.Bounds(t.min.subtract(e), t.max.add(e)), this._parts = [], this._pxBounds && this._pxBounds.intersects(t)) {
          if (this.options.noClip) return void(this._parts = this._rings)
          for (var n, s = 0,
                 o = this._rings.length; o > s; s++) n = L.PolyUtil.clipPolygon(this._rings[s], t, !0),
      ...
      _project: function () {
        ...
        if (n.distance === L.CRS.Earth.distance) {
          ...
          this._point = h.subtract(e.getPixelOrigin()),
            this._radius = isNaN(u) ? 0 : Math.max(Math.round(h.x - e.project([l, t - u]).x), 1),
            this._radiusY = Math.max(Math.round(h.y - a.y), 1)
        } else {
    ...
    L.circle = function (t, i, e) {
      return 'number' == typeof i && (i = L.extend({},
        e, {
          radius: i
        })),
        new L.Circle(t, i)
    ...
    function () {
      ...
      L.MultiPolyline = t(L.Polyline),
        L.MultiPolygon = t(L.Polygon),
        L.multiPolyline = function (t, i) {
      ...
      _update: function () {
        if (!this._map._animatingZoom || !this._bounds) {
          ...
          this._svgSize && this._svgSize.equals(i) || (this._svgSize = i, e.setAttribute('width', i.x), e.setAttribute('height', i.y)),
            L.DomUtil.setPosition(e, t.min),
            e.setAttribute('viewBox', [t.min.x, t.min.y, i.x, i.y].join(' '))
        }
      },
      _initPath: function (t) {
        var i = t._path = L.SVG.create('path')
        t.options.className && L.DomUtil.addClass(i, t.options.className),
        t.options.interactive && L.DomUtil.addClass(i, 'imap-interactive'),
          L.DomEvent.on(i, 'click dblclick mousedown mouseup contextmenu',
            function (t) {
              this.fire('click')
            },
            this),
    ...
    L.extend(L.SVG, {
      ...
      pointsToPath: function (t, i, e) {
        ...
        for (n = 0, o = t.length; o > n; n++) {
          for (r = t[n], s = 0, a = r.length; a > s; s++) h = r[s],
            l += (s ? 'L' : 'M') + h.x + ' ' + h.y;
      ...
      _drawPolylineArrow: function (t, i, e) {
        ...
        n = parseInt(t.x) + parseInt(1 * e * (t.x - i.x + (t.y - i.y) / 2) / l),
          s = parseInt(t.y) + parseInt(1 * e * (t.y - i.y - (t.x - i.x) / 2) / l),
          o = parseInt(t.x) + parseInt(1 * e * (t.x - i.x - (t.y - i.y) / 2) / l),
          a = parseInt(t.y) + parseInt(1 * e * (t.y - i.y + (t.x - i.x) / 2) / l),
          r = Math.round(t.x),
          h = Math.round(t.y)
        var u = '',
          c = ''
        return n && (u = ' M' + n + ' ' + s + ' L' + r + ' ' + h, c = ' M' + o + ' ' + a + ' L' + r + ' ' + h),
        u + c
      }
    }),
    ...
    L.SVG.include(L.Browser.vml ? {
      ...
      _initPath: function (t) {
        ...
        L.DomUtil.addClass(i, 'imap-vml-shape ' + (this.options.className || '')),
          i.coordsize = '1 1',
          t._path = L.SVG.create('path'),
      ...
      _updateStyle: function (t) {
        ...
        s.stroked = !!n.stroke,
          s.filled = !!n.fill,
          n.stroke ? (i || (i = t._stroke = L.SVG.create('stroke')), s.appendChild(i), i.weight = n.weight + 'px', i.color = n.color, i.opacity = n.opacity, n.dashArray ? i.dashStyle = L.Util.isArray(n.dashArray) ? n.dashArray.join(' ') : n.dashArray.replace(/( *, *)/g, ' ') : i.dashStyle = '', i.endcap = n.lineCap.replace('butt', 'flat'), i.joinstyle = n.lineJoin) : i && (s.removeChild(i), t._stroke = null),
          n.fill ? (e || (e = t._fill = L.SVG.create('fill')), s.appendChild(e), e.color = n.fillColor || n.color, e.opacity = n.fillOpacity) : e && (s.removeChild(e), t._fill = null)
      },
      _updateSector: function (t) {
        var i = t._parts,
  ...
  L.Browser.vml && (L.SVG.create = function () {
    ...
    L.Canvas = L.Renderer.extend({
      ...
      _initContainer: function () {
        ...
        L.DomEvent.on(t, 'mousemove', L.Util.throttle(this._onMouseMove, 32, this), this).on(t, 'click dblclick mousedown mouseup contextmenu', this._onClick, this).on(t, 'mouseout', this._handleMouseOut, this),
      ...
      _update: function () {
        if (!this._map._animatingZoom || !this._bounds) {
          ...
          L.DomUtil.setPosition(i, t.min),
            i.width = n * e.x,
            i.height = n * e.y,
            i.style.width = e.x + 'px',
            i.style.height = e.y + 'px',
          L.Browser.retina && this._ctx.scale(2, 2),
      ...
      _draw: function (t) {
        ...
        this._ctx.save(),
        e && (this._ctx.beginPath(), this._ctx.rect(e.min.x, e.min.y, e.max.x - e.min.x, e.max.y - e.min.y), this._ctx.clip())
        for (var n in this._layers) i = this._layers[n],
        (!e || i._pxBounds.intersects(e)) && i._updatePath(),
      ...
      _updatePoly: function (t, i) {
        ...
        if (r) {
          for (this._drawnLayers[t._map_id] = t, h.beginPath(), e = 0; r > e; e++) {
            for (n = 0, s = a[e].length; s > n; n++) o = a[e][n],
              h[n ? 'lineTo' : 'moveTo'](o.x, o.y);
            i && h.closePath()
          }
      ...
      _updateCircle: function (t) {
        if (!t._empty()) {
          ...
          1 !== s && (e.save(), e.scale(1, s)),
            e.beginPath(),
            e.arc(i.x, i.y / s, n, 0, 2 * Math.PI, !1),
          1 !== s && e.restore(),
      ...
      _fillStroke: function (t, i) {
        var e = this._clear,
          n = i.options
        t.globalCompositeOperation = e ? 'destination-out' : 'source-over',
        n.fill && (t.globalAlpha = e ? 1 : n.fillOpacity, t.fillStyle = n.fillColor || n.color, t.fill(n.fillRule || 'evenodd')),
        n.stroke && 0 !== n.weight && (t.globalAlpha = e ? 1 : n.opacity, i._prevWeight = t.lineWidth = e ? i._prevWeight + 1 : n.weight, t.strokeStyle = n.color, t.lineCap = n.lineCap, t.lineJoin = n.lineJoin, t.stroke())
      },
      _onClick: function (t) {
        var i, e = this._map.mouseEventToLayerPoint(t),
          n = []
        for (var s in this._layers) i = this._layers[s],
        i.options.interactive && i._containsPoint(e) && (L.DomEvent._fakeStop(t), n.push(i));
      ...
      _handleMouseHover: function (t, i) {
        var e, n
        if (!this._hoveredLayer) for (e in this._drawnLayers) if (n = this._drawnLayers[e], n.options.interactive && n._containsPoint(i)) {
          L.DomUtil.addClass(this._container, 'leador-interactive'),
    ...
    L.Polyline.prototype._containsPoint = function (t, i) {
      ...
      for (e = 0, o = this._parts.length; o > e; e++) for (r = this._parts[e], n = 0, a = r.length, s = a - 1; a > n; s = n++) if ((i || 0 !== n) && L.LineUtil.pointToSegmentDistance(t, r[s], r[n]) <= h) return !0
      return !1
    },
    L.Polygon.prototype._containsPoint = function (t) {
      var i, e, n, s, o, a, r, h, l = !1
      if (!this._pxBounds.contains(t)) return !1
      for (s = 0, r = this._parts.length; r > s; s++) for (i = this._parts[s], o = 0, h = i.length, a = h - 1; h > o; a = o++) e = i[o],
        n = i[a],
    ...
    L.GeoJSON = L.FeatureGroup.extend({
      ...
      addData: function (t) {
        ...
        if (s) {
          for (i = 0, e = s.length; e > i; i++) n = s[i],
      ...
      resetStyle: function (t) {
        return t.options = L.Util.extend({},
          t.defaultOptions),
  ...
  L.extend(L.GeoJSON, {
    geometryToLayer: function (t, i) {
      ...
      switch (a.type) {
        case 'Point':
          return e = u(r),
            l ? l(t, e) : new L.Marker(e)
        case 'MultiPoint':
          for (s = 0, o = r.length; o > s; s++) e = u(r[s]),
            h.push(l ? l(t, e) : new L.Marker(e));
          return new L.FeatureGroup(h)
        case 'LineString':
        case 'MultiLineString':
          return n = this.coordsToLatLngs(r, 'LineString' === a.type ? 0 : 1, u),
            new L.Polyline(n, i)
        case 'Polygon':
        case 'MultiPolygon':
          return n = this.coordsToLatLngs(r, 'Polygon' === a.type ? 1 : 2, u),
            new L.Polygon(n, i)
    ...
    coordsToLatLngs: function (t, i, e) {
      for (var n, s = [], o = 0,
             a = t.length; a > o; o++) n = i ? this.coordsToLatLngs(t[o], i - 1, e) : (e || this.coordsToLatLng)(t[o]),
        s.push(n);
      return s
    },
    ...
    latLngsToCoords: function (t, i, e) {
      for (var n = [], s = 0,
             o = t.length; o > s; s++) n.push(i ? L.GeoJSON.latLngsToCoords(t[s], i - 1, e) : L.GeoJSON.latLngToCoords(t[s]));
      return !i && e && n.push(n[0]),
        n
    },
    getFeature: function (t, i) {
      return t.feature ? L.extend({},
        t.feature, {
          geometry: i
  ...
  L.Marker.include(PointToGeoJSON),
    ...
    L.Handler.PathDrag = L.Handler.extend({
      ...
      addHooks: function () {
        ...
        this._draggable || (this._draggable = new L.Draggable(t, t, !0), this._draggable._updatePosition = function () {
          ...
          this._draggable.on({
            ...
            this).enable(),
          L.DomUtil.addClass(this._Object._renderer._rootGroup, 'imap-path-draggable')
      },
      removeHooks: function () {
        this._draggable.off({
            dragstart: this._onDragStart,
          ...
          this).disable(),
        L.Path.CANVAS || L.DomUtil.removeClass(this._Object._renderer._rootGroup, 'imap-path-draggable')
      },
      moved: function () {
        return this._draggable && this._draggable._moved
      },
      ...
      _onDrag: function (t) {
        this._transformPoints(t.offset),
          this._Object.fire('move', t).fire('drag', t)
      },
      _onDragEnd: function (t) {
      ...
      _transformPoints: function (t) {
        ...
        if (s._latlng = s._latlng || s._position, s._latlng) s._latlng = s._map.containerPointToLatLng(s._map.latLngToContainerPoint(s._latlng)._subtract(t)),
          s.setLatLng(s._latlng)
        else if (s._latlngs) {
    ...
    function () {
      ...
      L.FeatureGroup.EVENTS += ' dragstart',
        t([L.MultiPolygon, L.MultiPolyline], 'addLayer', i),
        t([L.MultiPolygon, L.MultiPolyline], 'removeLayer', e)
      var n = {
        _onDrag: function (t) {
          var i = t.target
      ...
      L.MultiPolygon.include(n),
        L.MultiPolyline.include(n)
    }(),
    L.Edit = L.Edit || {},
    L.Edit.Poly = L.Handler.extend({
      ...
      _initMarkers: function () {
        ...
        for (t = 0, e = s.length; e > t; t++) n = this._createMarker(s[t], t),
          n.on('click', this._onMarkerClick, this),
      ...
      _onMarkerDrag: function (t) {
        var i = t.target
        L.extend(i._origLatLng, i._latlng),
      ...
      _createMiddleMarker: function (t, i) {
        ...
        a.setOpacity(.6),
          ...
          n = function () {
            var n = i._index
            a._index = n,
              a.off('click', e).on('click', this._onMarkerClick, this),
              o.lat = a.getLatLng().lat,
              o.lng = a.getLatLng().lng,
              this._poly.spliceLatLngs(n, 0, o),
          ...
          a.on('click', e, this).on('dragstart', n, this).on('dragend', s, this),
    ...
    L.Edit.SimpleShape = L.Handler.extend({
      ...
      removeHooks: function () {
        if (this._shape._map) {
          for (var t = 0,
                 i = this._resizeMarkers.length; i > t; t++) this._unbindMarker(this._resizeMarkers[t]);
      ...
      _onMarkerDrag: function (t) {
        var i = t.target,
          e = i.getLatLng()
        i === this._moveMarker ? this._move(e) : this._resize(e),
          this._shape.redraw()
      },
    ...
    L.Edit.Rectangle = L.Edit.SimpleShape.extend({
      ...
      _createResizeMarker: function () {
        ...
        this._resizeMarkers = []
        for (var i = 0,
               e = t.length; e > i; i++) this._resizeMarkers.push(this._createMarker(t[i], this.options.resizeIcon)),
      ...
      _move: function (t) {
        for (var i, e = this._shape.getLatLngs(), n = this._shape.getBounds(), s = n.getCenter(), o = [], a = 0,
               r = e.length; r > a; a++) i = [e[a].lat - s.lat, e[a].lng - s.lng],
      ...
      _toggleCornerMarkers: function (t) {
        for (var i = 0,
               e = this._resizeMarkers.length; e > i; i++) this._resizeMarkers[i].setOpacity(t)
      },
      _repositionCornerMarkers: function () {
        for (var t = this._getCorners(), i = 0,
               e = this._resizeMarkers.length; e > i; i++) this._resizeMarkers[i].setLatLng(t[i])
      }
    }),
    ...
    L.Edit.Circle = L.Edit.SimpleShape.extend({
      _createResizeMarker: function () {
        ...
        this._resizeMarkers = [],
          this._resizeMarkers.push(this._createMarker(i, this.options.resizeIcon))
      },
      ...
      _move: function (t) {
        ...
        this._resizeMarkers[0].setLatLng(i),
    ...
    L.Label = (L.Layer ? L.Layer : L.Class).extend({
      ...
      onAdd: function (t) {
        this._map = t,
          this._pane = this.options.pane ? t._panes[this.options.pane] : this._source instanceof L.Marker ? t._panes.markerPane : t._panes.popupPane,
        this._parentContainer || this._initLayout(),
          this._pane.appendChild(this._parentContainer),
          this._initInteraction(),
          this._update(),
      ...
      onRemove: function (t) {
        this._pane.removeChild(this._parentContainer),
          t.off({
      ...
      updateZIndex: function (t) {
        this._zIndex = t,
        this._parentContainer && this._zIndex && (this._parentContainer.style.zIndex = t)
      },
      setOpacity: function (t) {
        this.options.opacity = t,
        this._container && L.DomUtil.setOpacity(this._container, t)
      },
      getOptions: function () {
        return this.options
      },
      ...
      _initLayout: function () {
        this._parentContainer = L.DomUtil.create('div', ''),
          this._parentContainer.style.position = 'absolute',
          this._parentContainer.style.zIndex = 210,
          this._container = L.DomUtil.create('div', 'imap-label ' + this.options.className + ' imap-zoom-animated'),
          this._container.style.color = this.options.fontColor,
          this._container.style.font = this.options.fontSize + 'px "' + this.options.fontName + '"',
          this._container.style.fontWeight = this.options.fontBold ? 'bold' : 'normal',
      ...
      _setPosition: function (t) {
        ...
        'right' === o || 'auto' === o && s.x < n.x ? (L.DomUtil.removeClass(e, 'imap-label-left'), t = t.add(r)) : (L.DomUtil.addClass(e, 'imap-label-left'), L.DomUtil.removeClass(e, 'imap-label-right'), t = t.add(L.point(-r.x - a, r.y))),
          t = t.subtract(h),
          L.DomUtil.setPosition(e, t)
      },
      ...
      _initInteraction: function () {
        if (this.options.clickable) {
          ...
          L.DomUtil.addClass(t, 'imap-clickable'),
            L.DomEvent.on(t, 'click', this._onMouseClick, this),
            L.DomEvent.on(t, 'contextmenu',
              function (t) {
                L.DomEvent.preventDefault(t)
              },
              this)
      ...
      _removeInteraction: function () {
        if (this.options.clickable) {
          var t = this._parentContainer,
            i = ['dblclick', 'mousedown', 'mouseover', 'mouseout', 'contextmenu']
          L.DomUtil.removeClass(t, 'imap-clickable'),
            L.DomEvent.off(t, 'click', this._onMouseClick, this)
          for (var e = 0; e < i.length; e++) L.DomEvent.off(t, i[e], this._fireMouseEvent, this)
        }
      },
      _onMouseClick: function (t) {
        this.hasEventListeners(t.type) && L.DomEvent.stopPropagation(t),
          this.fire(t.type, {
            originalEvent: t
          })
      },
    ...
    L.BaseMarkerMethods = {
      ...
      bindLabel: function (t, i) {
        return this._labelNoHide = i.noHide,
        this.label || (this._labelNoHide || this._addLabelRevealHandlers(), this.on('remove', this.hideLabel, this).on('move', this._moveLabel, this).on('add', this._onMarkerAdd, this), this._hasLabelHandlers = !0),
          'object' == typeof t ? this.label = t : this.label = new L.Label(i, this).setContent(t),
          this
      },
      unbindLabel: function () {
        return this.label && (this.hideLabel(), this.label = null, this._hasLabelHandlers && (this._labelNoHide || this._removeLabelRevealHandlers(), this.off('remove', this.hideLabel, this).off('move', this._moveLabel, this).off('add', this._onMarkerAdd, this)), this._hasLabelHandlers = !1),
          this
      },
    ...
    L.Marker.include({
      ...
      _updateZIndex: function (t) {
        ...
        this.label && this.label.updateZIndex(i)
      },
      _originalSetOpacity: L.Marker.prototype.setOpacity,
      setOpacity: function (t, i) {
        this.options.labelHasSemiTransparency = i,
    ...
    L.Path.include({
      bindLabel: function (t, i) {
        return this.label && this.label.options === i || (this.label = new L.Label(i, this)),
          this.label.setContent(t),
        this._showLabelAdded || (this.on('mouseover', this._showLabel, this).on('mousemove', this._moveLabel, this).on('mouseout remove', this._hideLabel, this), L.Browser.touch && this.on('click', this._showLabel, this), this._showLabelAdded = !0),
          this
      },
      unbindLabel: function () {
        return this.label && (this._hideLabel(), this.label = null, this._showLabelAdded = !1, this.off('mouseover', this._showLabel, this).off('mousemove', this._moveLabel, this).off('mouseout remove', this._hideLabel, this)),
          this
      },
      updateLabelContent: function (t) {
        this.label && this.label.setContent(t)
    ...
    L.Control = L.Class.extend({
      ...
      visible: function (t) {
        ...
        i && (t ? i.style.visibility = 'inherit' : i.style.visibility = 'hidden'),
          this.options.visible = t
      },
      addTo: function (t) {
        this.remove(),
        ...
        return e.indexOf && -1 !== e.indexOf('bottom') ? n.insertBefore(i, n.firstChild) : n.appendChild(i),
          this.visible(this.options.visible),
          this._calculatePosition(),
          t.on('resize', this._calculatePosition, this),
          this
      },
      _calculatePosition: function () {
        ...
        if (i && t._map) {
          ...
          a += Math.floor(e.offset.x),
            r += Math.floor(e.offset.y),
            i.style.left = a + 'px',
            i.style.top = r + 'px'
        }
      },
    ...
    L.Control.Zoom = L.Control.extend({
      ...
      _createButton: function (t, i, e, n, s) {
        ...
        return o.innerHTML = t,
          o.href = '#',
          o.title = i,
          L.DomEvent.on(o, 'mousedown dblclick', L.DomEvent.stopPropagation).on(o, 'click', L.DomEvent.stop).on(o, 'click', s, this).on(o, 'click', this._refocusOnMap, this),
          o
      },
      _updateDisabled: function () {
        var t = this._map,
          i = 'imap-disabled'
        L.DomUtil.removeClass(this._zoomInButton, i),
          L.DomUtil.removeClass(this._zoomOutButton, i),
        (this._disabled || t._zoom === t.getMinZoom()) && L.DomUtil.addClass(this._zoomOutButton, i),
        (this._disabled || t._zoom === t.getMaxZoom()) && L.DomUtil.addClass(this._zoomInButton, i)
      }
    }),
    L.Control.Attribution = L.Control.extend({
      ...
      onAdd: function (t) {
        return this._container = L.DomUtil.create('div', 'imap-control-attribution'),
        L.DomEvent && L.DomEvent.disableClickPropagation(this._container),
          this._update(),
          this._container
      },
    ...
    L.Control.Scale = L.Control.extend({
      ...
      _addScales: function (t, i, e) {
        t.metric && (this._mScale = L.DomUtil.create('div', i, e)),
        t.imperial && (this._iScale = L.DomUtil.create('div', i, e))
      },
      _update: function () {
        var t = this._map,
          i = t.getSize().y / 2,
    ...
    L.Control.Layers = L.Control.extend({
      ...
      _initLayout: function () {
        ...
        L.Browser.touch || L.DomEvent.disableScrollPropagation(i)
        ...
        if (this.options.collapsed) {
          ...
          n.href = '#',
            n.title = 'Layers',
            L.Browser.touch ? L.DomEvent.on(n, 'click', L.DomEvent.stop).on(n, 'click', this._expand, this) : L.DomEvent.on(n, 'focus', this._expand, this),
        ...
        this._baseLayersList = L.DomUtil.create('div', t + '-base', e),
          this._separator = L.DomUtil.create('div', t + '-separator', e),
          this._overlaysList = L.DomUtil.create('div', t + '-overlays', e),
          i.appendChild(e)
      },
      ...
      _addItem: function (t) {
        ...
        t.overlay ? (i = document.createElement('input'), i.type = 'checkbox', i.className = 'imap-control-layers-selector', i.defaultChecked = n) : i = this._createRadioElement('imap-base-layers', n),
          i.layerId = L.stamp(t.layer),
      ...
      _onInputClick: function () {
        ...
        for (var a = n.length - 1; a >= 0; a--) t = n[a],
          i = this._layers[t.layerId].layer,
          e = this._map.hasLayer(i),
          t.checked && !e ? s.push(i) : !t.checked && e && o.push(i);
      ...
      _expand: function () {
        L.DomUtil.addClass(this._container, 'imap-control-layers-expanded'),
          this._form.style.height = null
        var t = this._map._size.y - (this._container.offsetTop + 50)
        t < this._form.clientHeight ? (L.DomUtil.addClass(this._form, 'imap-control-layers-scrollbar'), this._form.style.height = t + 'px') : L.DomUtil.removeClass(this._form, 'imap-control-layers-scrollbar'),
          this._checkDisabledLayers()
      },
      _collapse: function () {
      ...
      _checkDisabledLayers: function () {
        for (var t, i, e = this._form.getElementsByTagName('input'), n = this._map.getZoom(),
               s = e.length - 1; s >= 0; s--) t = e[s],
          i = this._layers[t.layerId].layer,
          t.disabled = i.options.minZoom !== undefined && n < i.options.minZoom || i.options.maxZoom !== undefined && n > i.options.maxZoom
      }
    }),
    ...
    L.Map.include({
      ...
      locate: function (t) {
        if (t = this._locateOptions = L.extend({},
...
function s(e) {
  ...
  e.Function = {
    ...
    unSelect: function(a) {
      "WebkitUserSelect" in document.documentElement.style ? (a.style.WebkitUserSelect = "text", a.style.onselectstart = "return true;") : "MozUserSelect" in document.documentElement.style ? a.style.MozUserSelect = "text" : "OUserSelect" in document.documentElement.style ? a.style.ib = "text" : "msUserSelect" in document.documentElement.style ? a.style.Ja = "text" : (a.unselectable = "on", a.style.Ja = "text", a.onselectstart = "return true;")
    },
    pageSize: function(a) {
  ...
  e.OverlayLayer = e.Class(e.Layer, {
    ...
    addOverlay: function(a, b) {
      var c = this.a;
      if(c && !this.A[a.getId()] && (a instanceof e.Overlay || a instanceof IMAPVector || a instanceof e.PointCollection || a instanceof e.HeatmapOverlay)) {
    ...
    removeOverlay: function(a) {
      ...
      if(a) {
        if(a instanceof e.Overlay || a instanceof IMAPVector || a instanceof e.PointCollection || a instanceof e.HeatmapOverlay) {
...
/* 第三个js */
//js map
IMAP.Host = "http://" + tmapHost + "/jsmap";
//msp服务
IMAP.ApiHost = "http://" + tmapHost + "";
//插件的
IMAP.pluginsUrl = "http://" + tmapHost + "/as/webapi/js/auth?v=1.0&t=jsmap&ak=ec85d3648154874552835438ac6a02b2&m=";
//栅格图片
IMAP.TileServerUrl = ["http://{s}/v3/tile?z={z}&x={x}&y={y}",[tmapHost + "", tmapHost + ""]];

//
////四川省厅
//IMAP.Host = "http://" + "10.64.203.127" + ":25002/jsmap";
////msp服务
//IMAP.ApiHost = "http://" + "10.64.203.127" + ":25001";
////插件的
//IMAP.pluginsUrl = "http://" + "10.64.203.127" + ":25001/as/webapi/js/auth?v=1.0&t=jsmap&ak=ec85d3648154874552835438ac6a02b2&m=";
////栅格图片
//IMAP.TileServerUrl = ["http://{s}/v3/tile?z={z}&x={x}&y={y}",["10.64.203.127" + ":25003", "10.64.203.127"+ ":25003"]];


////js map 广安
//IMAP.Host = "http://" + "10.64.203.127" + ":25002/jsmap";
////msp服务
//IMAP.ApiHost = "http://" + "10.69.5.125" + ":25001";
////插件的
//IMAP.pluginsUrl = "http://" + "10.69.5.125" + ":25001/as/webapi/js/auth?v=1.0&t=jsmap&ak=ec85d3648154874552835438ac6a02b2&m=";
////栅格图片
//IMAP.TileServerUrl = ["http://{s}/v3/tile?z={z}&x={x}&y={y}",["10.64.203.127"  + ":25003", "10.64.203.127"  + ":25003"]];
