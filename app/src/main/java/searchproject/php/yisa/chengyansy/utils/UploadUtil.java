...
public class UploadUtil {
    ...
    public  void uploadFile(String filePath, String fileKey, String RequestURL,
                           Map<String, String> param,String token) {
        if (filePath == null) {
        ...
        try {
            ...
            uploadFile(file, fileKey, RequestURL, param,token);
        } catch (Exception e) {
            sendMessage(UPLOAD_FILE_NOT_EXISTS_CODE,"文件不存在");
            e.printStackTrace();
            return;
    ...
    public void uploadFile(final File file, final String fileKey,
                           final String RequestURL, final Map<String, String> param,String token) {
...
public String toUploadFile(String filePath, final String fileKey, final String RequestURL, Map<String, String> param, String token){
    final File file;
    int res=0;
