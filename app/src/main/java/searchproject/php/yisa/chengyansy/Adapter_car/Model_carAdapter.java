...
public class Model_carAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    Context context;
    private List<Car_result_model> dataList;

    public Model_carAdapter(List dataList , Context context) {
    ...
    private Model_carAdapter.OnItemClickLitener mOnItemClickLitener;

    public void setOnItemClickLitener(Model_carAdapter.OnItemClickLitener mOnItemClickLitener)
    {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder){
            ...
            ((MyViewHolder)holder).text.setText(dataList.get(position).getText());
            ((MyViewHolder)holder).count.setText(dataList.get(position).getNum());
...
//            time_created= (TextView) itemView.findViewById(R.id.car_time_created);
