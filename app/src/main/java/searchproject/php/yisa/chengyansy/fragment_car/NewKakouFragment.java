...
public class NewKakouFragment extends Fragment {
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case  200:
                    final List<Car_result_kk> list=(List)msg.obj;
                    dataList=list;
                        ...
                        public void onItemClick(View view, final int position) {
                            ...
                            new  Thread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Iterator<Map.Entry<String, String>> it = hashMapcm.entrySet().iterator();
                                    while (it.hasNext()) {
                                        Map.Entry<String, String> entry = it.next();
                                        hashMapcm_click.put(entry.getKey()+"",entry.getValue()+"");
                                        //    System.out.println("KKkey= " + entry.getKey() + " and value= " + entry.getValue());
                                    }
                                    hashMapcm_click.put("pn","1");
                                    hashMapcm_click.put("location_id",dataList.get(position).getId());
                                    ...
                                    final String result=    HttpConnectionUtils.sendGETRequest(HttpConnectionUtils.ipport+"/api/car_result",hashMapcm_click,token);
...
//                                        });
                                        ...
                                        bundle1.putSerializable("hashMap",(Serializable)hashMapcm_click);
    ...
    private HashMap hashMapcm_click=new HashMap();
    ...
    private void initHttp(final String firstTime, final String endTime, final String plate_name){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String result=    HttpConnectionUtils.sendGETRequest(HttpConnectionUtils.ipport+"/api/car_result_kk",hashMapcm,token);
...
//                        });
                        ...
                        Log.e("--","---");
                        HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_kk", hashMapcm, null);
                        // HttpConnectionUtils.sendGETRequestText(HttpConnectionUtils.ipport+"/api/car_result_kk",hashMap,token);
                        final String result = HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_kk", hashMapcm, token);
                        //   final String result = initJson();
