...
public class KakouFragment extends Fragment {
                      ...
                      public void onItemClick(View view, final int position) {
                          ...
                          new  Thread(new Runnable() {
                              ...
                              public void run() {
                                  ...
                                  Iterator<Map.Entry<String, String>> it = hashMapkk.entrySet().iterator();
                                  while (it.hasNext()) {
                                      Map.Entry<String, String> entry = it.next();
                                      hashMapkk_click.put(entry.getKey()+"",entry.getValue()+"");
                                      //    System.out.println("KKkey= " + entry.getKey() + " and value= " + entry.getValue());
                                  }
                                  hashMapkk_click.put("location_id",dataList.get(position).getId());
                                  ...
                                  final String result=    HttpConnectionUtils.sendGETRequest(HttpConnectionUtils.ipport+"/api/car_result",hashMapkk_click,token);
...
//                                      });
    ...
    private HashMap hashMapkk_click=new HashMap();
...
//                final String result=    HttpConnectionUtils.sendGETRequest("10.73.194.252:8088/api/car_result_kk",hashMap,token);
       ...
       //         HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_kk",hashMap,token);
...
//
        ...
        Log.e("--","---");
        //"http://" + path+"?"+"plate="+plate+"&beginDate="+firstTime+"&endDate="+endTime+"&pn="+pn
         //HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_kk", hashMapkk, null);
       //final String result =  HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_kk", hashMap1, token);
//        handler.post(new Runnable() {
//            @Override
//            public void run() {
//                Toast.makeText(getActivity(),"HH"+"http://" + HttpConnectionUtils.ipport+"/api/car_result_kk"+"?"+"plate="+plate_name+"&beginDate="+firstTime+"&endDate="+endTime+"&pn="+i_page_index+"",Toast.LENGTH_SHORT).show();
//            }
//        });
        //"鲁BH*","2017-08-15 08:08:08","2017-08-17 08:08:08","2"
        //    final String result = sendGETRequestRight(plate_name,firstTime,endTime,i_page_index+"");
        final String result = sendGETRequestRight("鲁BH*","2017-08-15 08:08:08","2017-08-17 08:08:08","2");
//        handler.post(new Runnable() {
//            @Override
//            public void run() {
...
//
//    }
public  String sendGETRequestRight(String palte,String frist,String end,String pn) {
    String result =null;
    ...
    try {
        ...
        //     URL url = new URL("http://" + path+"plate="+plate+"&beginDate="+firstTime+"&endDate="+endTime+"&pn="+pn);http://10.50.235.37:8088/api/car_result_kk?plate=%E9%B2%81H5*&beginDate=2017-08-15%2011:24:00&endDate=2017-08-17%2011:24:00&pn=3
        URL url = new URL("http://10.50.235.37:8088/api/car_result_kk?plate=%E9%B2%81H5*&beginDate=2017-08-15%2011:24:00&endDate=2017-08-17%2011:24:00&pn=3");
...
public  String sendGETRequestRightgg(String path, String plate,String firstTime,String endTime,String pn,String token) {
    String result =null;
    ...
    try {
        ...
        URL url = new URL("http://" + path+"plate="+plate+"&beginDate="+firstTime+"&endDate="+endTime+"&pn="+pn);
        conn = (HttpURLConnection) url.openConnection();
        if(token!=null) {
            //     conn.setRequestProperty("Authorization","token " +token);
            conn.addRequestProperty("Authorization","token " +token);
