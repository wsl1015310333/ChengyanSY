...
public class DetailResult_carAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DetailResult_carAdapter(List dataList , Context context) {
    ...
    private DetailResult_carAdapter.OnItemClickLitener mOnItemClickLitener;

    public void setOnItemClickLitener(DetailResult_carAdapter.OnItemClickLitener mOnItemClickLitener)
    {
