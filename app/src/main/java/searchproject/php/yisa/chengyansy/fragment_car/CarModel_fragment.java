...
public class CarModel_fragment extends Fragment {
                        ...
                        public void onItemClick(View view, final int position) {
                            ...
                            new  Thread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    hashMapcm_click.put("year_id",dataList.get(position).getYear_id());
...
//                        });
                        ...
                        Log.e("--","---");
                        HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_model", hashMapcm, null);
                       // HttpConnectionUtils.sendGETRequestText(HttpConnectionUtils.ipport+"/api/car_result_kk",hashMap,token);
                        final String result = HttpConnectionUtils.sendGETRequestRight(HttpConnectionUtils.ipport+"/api/car_result_model", hashMapcm, token);
                           //   final String result = initJson();
