package searchproject.php.yisa.chengyansy.view;
...
private Context context;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < strChars.length; i++) {
           ...
           //     mPaint.setColor(getResources().getColor(R.color.letterclick));
                mPaint.setColor(getResources().getColor(R.color.lettertext));
